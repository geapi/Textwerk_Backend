...
this.length=1;return this}if(bp==="body"&&!bs&&aa.body){this.context=aa;this[0]=aa.body;
this.selector="body";this.length=1;return this}if(typeof bp==="string"){br=bo.exec(bp);
if(br&&(br[1]||!bs)){if(br[1]){bu=(bs?bs.ownerDocument||bs:aa);bq=a0.exec(bp);if(bq){if(a4.isPlainObject(bs)){bp=[aa.createElement(bq[1])];
a4.fn.attr.call(bp,bs,true)}else{bp=[bu.createElement(bq[1])]}}else{bq=a4.buildFragment([br[1]],[bu]);
bp=(bq.cacheable?bq.fragment.cloneNode(true):bq.fragment).childNodes}return a4.merge(this,bp)
}else{bt=aa.getElementById(br[2]);if(bt&&bt.parentNode){if(bt.id!==br[2]){return a2.find(bp)
...
},pushStack:function(bq,bs,bp){var br=a4();if(a4.isArray(bq)){aY.apply(br,bq)}else{a4.merge(br,bq)
}br.prevObject=this;br.context=this.context;if(bs==="find"){br.selector=this.selector+(this.selector?" ":"")+bp
}else{if(bs){br.selector=this.selector+"."+bs+"("+bp+")"}}return br},each:function(bq,bp){return a4.each(this,bq,bp)
},ready:function(bp){a4.bindReady();if(a4.isReady){bp.call(aa,a4)}else{if(a1){a1.push(bp)
}}return this},eq:function(bp){return bp===-1?this.slice(bp):this.slice(bp,+bp+1)
...
}))},end:function(){return this.prevObject||a4(null)},push:aY,sort:[].sort,splice:[].splice};
a4.fn.init.prototype=a4.fn;a4.extend=a4.fn.extend=function(){var by,br,bp,bq,bv,bw,bu=arguments[0]||{},bt=1,bs=arguments.length,bx=false;
if(typeof bu==="boolean"){bx=bu;bu=arguments[1]||{};bt=2}if(typeof bu!=="object"&&!a4.isFunction(bu)){bu={}
}if(bs===bt){bu=this;--bt}for(;bt<bs;bt++){if((by=arguments[bt])!=null){for(br in by){bp=bu[br];
bq=by[br];if(bu===bq){continue}if(bx&&bq&&(a4.isPlainObject(bq)||(bv=a4.isArray(bq)))){if(bv){bv=false;
bw=bp&&a4.isArray(bp)?bp:[]}else{bw=bp&&a4.isPlainObject(bp)?bp:{}}bu[br]=a4.extend(bx,bw,bq)
}else{if(bq!==B){bu[br]=bq}}}}}return bu};a4.extend({noConflict:function(bp){aE.$=a6;
if(bp){aE.jQuery=bk}return a4},isReady:false,readyWait:1,ready:function(bs){if(bs===true){a4.readyWait--
}if(!a4.readyWait||(bs!==true&&!a4.isReady)){if(!aa.body){return setTimeout(a4.ready,1)
}a4.isReady=true;if(bs!==true&&--a4.readyWait>0){return}if(a1){var br,bp=0,bq=a1;
a1=null;while((br=bq[bp++])){br.call(aa,a4)}if(a4.fn.trigger){a4(aa).trigger("ready").unbind("ready")
}}}},bindReady:function(){if(bj){return}bj=true;if(aa.readyState==="complete"){return setTimeout(a4.ready,1)
}if(aa.addEventListener){aa.addEventListener("DOMContentLoaded",aR,false);aE.addEventListener("load",a4.ready,false)
}else{if(aa.attachEvent){aa.attachEvent("onreadystatechange",aR);aE.attachEvent("onload",a4.ready);
var bp=false;try{bp=aE.frameElement==null}catch(bq){}if(aa.documentElement.doScroll&&bp){aT()
...
bp.type="text/javascript";if(a4.support.scriptEval){bp.appendChild(aa.createTextNode(br))
}else{bp.text=br}bq.insertBefore(bp,bq.firstChild);bq.removeChild(bp)}},nodeName:function(bq,bp){return bq.nodeName&&bq.nodeName.toUpperCase()===bp.toUpperCase()
...
}}}else{for(var bv=bs[0];bt<bu&&bw.call(bv,bt,bv)!==false;bv=bs[++bt]){}}}return bs
},trim:be?function(bp){return bp==null?"":be.call(bp)}:function(bp){return bp==null?"":bp.toString().replace(a8,"").replace(a3,"")
},makeArray:function(bs,bq){var bp=bq||[];if(bs!=null){var br=a4.type(bs);if(bs.length==null||br==="string"||br==="function"||br==="regexp"||a4.isWindow(bs)){aY.call(bp,bs)
}else{a4.merge(bp,bs)}}return bp},inArray:function(br,bs){if(bs.indexOf){return bs.indexOf(br)
}for(var bp=0,bq=bs.length;bp<bq;bp++){if(bs[bp]===br){return bp}}return -1},merge:function(bt,br){var bs=bt.length,bq=0;
if(typeof br.length==="number"){for(var bp=br.length;bq<bp;bq++){bt[bs++]=br[bq]}}else{while(br[bq]!==B){bt[bs++]=br[bq++]
}}bt.length=bs;return bt},grep:function(bq,bv,bp){var br=[],bu;bp=!!bp;for(var bs=0,bt=bq.length;
bs<bt;bs++){bu=!!bv(bq[bs],bs);if(bp!==bu){br.push(bq[bs])}}return br},map:function(bq,bv,bp){var br=[],bu;
for(var bs=0,bt=bq.length;bs<bt;bs++){bu=bv(bq[bs],bs,bp);if(bu!=null){br[br.length]=bu
...
if(typeof bx==="object"){for(var bs in bx){a4.access(bp,bs,bx[bs],br,bu,bv)}return bp
}if(bv!==B){br=!bw&&br&&a4.isFunction(bv);for(var bt=0;bt<bq;bt++){bu(bp[bt],bx,br?bv.call(bp[bt],bt,bu(bp[bt],bx)):bv,bw)
}return bp}return bq?bu(bp[0],bx):B},now:function(){return(new Date()).getTime()},uaMatch:function(bq){bq=bq.toLowerCase();
...
});bl=a4.uaMatch(bn);if(bl.browser){a4.browser[bl.browser]=true;a4.browser.version=bl.version
}if(a4.browser.webkit){a4.browser.safari=true}if(aS){a4.inArray=function(bp,bq){return aS.call(bq,bp)
}}if(!aZ.test("\xA0")){a8=/^[\s\xA0]+/;a3=/[\s\xA0]+$/}a2=a4(aa);if(aa.addEventListener){aR=function(){aa.removeEventListener("DOMContentLoaded",aR,false);
a4.ready()}}else{if(aa.attachEvent){aR=function(){if(aa.readyState==="complete"){aa.detachEvent("onreadystatechange",aR);
a4.ready()}}}}function aT(){if(a4.isReady){return}try{aa.documentElement.doScroll("left")
}catch(bp){setTimeout(aT,1);return}a4.ready()}return(aE.jQuery=aE.$=a4)})();(function(){a.support={};
...
}catch(aV){}aY.insertBefore(aX,aY.firstChild);if(aE[aS]){a.support.scriptEval=true;
delete aE[aS]}try{delete aX.test}catch(aV){a.support.deleteExpando=false}aY.removeChild(aX);
if(aR.attachEvent&&aR.fireEvent){aR.attachEvent("onclick",function a2(){a.support.noCloneEvent=false;
aR.detachEvent("onclick",a2)});aR.cloneNode(true).fireEvent("onclick")}aR=aa.createElement("div");
aR.innerHTML="<input type='radio' name='radiotest' checked='checked'/>";var aU=aa.createDocumentFragment();
aU.appendChild(aR.firstChild);a.support.checkClone=aU.cloneNode(true).cloneNode(true).lastChild.checked;
a(function(){var a4=aa.createElement("div");a4.style.width=a4.style.paddingLeft="1px";
aa.body.appendChild(a4);a.boxModel=a.support.boxModel=a4.offsetWidth===2;if("zoom" in a4.style){a4.style.display="inline";
a4.style.zoom=1;a.support.inlineBlockNeedsLayout=a4.offsetWidth===2;a4.style.display="";
a4.innerHTML="<div style='width:4px;'></div>";a.support.shrinkWrapBlocks=a4.offsetWidth!==2
}a4.innerHTML="<table><tr><td style='padding:0;display:none'></td><td>t</td></tr></table>";
var a3=a4.getElementsByTagName("td");a.support.reliableHiddenOffsets=a3[0].offsetHeight===0;
a3[0].style.display="";a3[1].style.display="none";a.support.reliableHiddenOffsets=a.support.reliableHiddenOffsets&&a3[0].offsetHeight===0;
a4.innerHTML="";aa.body.removeChild(a4).style.display="none";a4=a3=null});var aW=function(a3){var a5=aa.createElement("div");
a3="on"+a3;var a4=(a3 in a5);if(!a4){a5.setAttribute(a3,"return;");a4=typeof a5[a3]==="function"
}a5=null;return a4};a.support.submitBubbles=aW("submit");a.support.changeBubbles=aW("change");
aY=aX=aR=a1=aZ=null})();var aL={},al=/^(?:\{.*\}|\[.*\])$/;a.extend({cache:{},uuid:0,expando:"jQuery"+a.now(),noData:{embed:true,object:"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000",applet:true},data:function(aT,aS,aW){if(!a.acceptData(aT)){return
...
}else{a.extend(aR,aS)}}else{if(aV&&!aR[aX]){aR[aX]={}}}aU=aV?aR[aX]:aR;if(aW!==B){aU[aS]=aW
}return typeof aS==="string"?aU[aS]:aU},removeData:function(aT,aS){if(!a.acceptData(aT)){return
}aT=aT==aE?aL:aT;var aV=aT.nodeType,aX=aV?aT[a.expando]:aT,aR=a.cache,aU=aV?aR[aX]:aX;
if(aS){if(aU){delete aU[aS];if(aV&&a.isEmptyObject(aU)){a.removeData(aT)}}}else{if(aV&&a.support.deleteExpando){delete aT[a.expando]
}else{if(aT.removeAttribute){aT.removeAttribute(a.expando)}else{if(aV){delete aR[aX]
}else{for(var aW in aT){delete aT[aW]}}}}}},acceptData:function(aS){if(aS.nodeName){var aR=a.noData[aS.nodeName.toLowerCase()];
if(aR){return !(aR===true||aS.getAttribute("classid")!==aR)}}return true}});a.fn.extend({data:function(aV,aX){var aW=null;
if(typeof aV==="undefined"){if(this.length){var aR=this[0].attributes,aT;aW=a.data(this[0]);
for(var aU=0,aS=aR.length;aU<aS;aU++){aT=aR[aU].name;if(aT.indexOf("data-")===0){aT=aT.substr(5);
...
if(aS==="inprogress"){aS=aR.shift()}if(aS){if(aT==="fx"){aR.unshift("inprogress")
}aS.call(aU,function(){a.dequeue(aU,aT)})}}});a.fn.extend({queue:function(aR,aS){if(typeof aR!=="string"){aS=aR;
aR="fx"}if(aS===B){return a.queue(this[0],aR)}return this.each(function(aU){var aT=a.queue(this,aR,aS);
if(aR==="fx"&&aT[0]!=="inprogress"){a.dequeue(this,aR)}})},dequeue:function(aR){return this.each(function(){a.dequeue(this,aR)
})},delay:function(aS,aR){aS=a.fx?a.fx.speeds[aS]||aS:aS;aR=aR||"fx";return this.queue(aR,function(){var aT=this;
setTimeout(function(){a.dequeue(aT,aR)},aS)})},clearQueue:function(aR){return this.queue(aR||"fx",[])
}});var aj=/[\n\t]/g,aI=/\s+/,an=/\r/g,aH=/^(?:href|src|style)$/,c=/^(?:button|input)$/i,w=/^(?:button|input|object|select|textarea)$/i,h=/^a(?:rea)?$/i,J=/^(?:radio|checkbox)$/i;
...
}else{var aV=" "+aS.className+" ",aX=aS.className;for(var aW=0,aZ=aR.length;aW<aZ;
aW++){if(aV.indexOf(" "+aR[aW]+" ")<0){aX+=" "+aR[aW]}}aS.className=a.trim(aX)}}}}return this
...
for(var aY=0,aR=aX.length;aY<aR;aY++){aU=aU.replace(" "+aX[aY]+" "," ")}aV.className=a.trim(aU)
}else{aV.className=""}}}}return this},toggleClass:function(aU,aS){var aT=typeof aU,aR=typeof aS==="boolean";
if(a.isFunction(aU)){return this.each(function(aW){var aV=a(this);aV.toggleClass(aU.call(this,aW,aV.attr("class"),aS),aS)
})}return this.each(function(){if(aT==="string"){var aX,aW=0,aV=a(this),aY=aS,aZ=aU.split(aI);
while((aX=aZ[aW++])){aY=aR?aY:!aV.hasClass(aX);aV[aY?"addClass":"removeClass"](aX)
...
},hasClass:function(aR){var aU=" "+aR+" ";for(var aT=0,aS=this.length;aT<aS;aT++){if((" "+this[aT].className+" ").replace(aj," ").indexOf(aU)>-1){return true
...
if(aX<0){return null}for(var aU=aW?aX:0,aY=aW?aX+1:a1.length;aU<aY;aU++){var aV=a1[aU];
...
if(this.nodeType!==1){return}if(aR){a5=aZ.call(this,a4,a3.val())}if(a5==null){a5=""
}else{if(typeof a5==="number"){a5+=""}else{if(a.isArray(a5)){a5=a.map(a5,function(a6){return a6==null?"":a6+""
})}}}if(a.isArray(a5)&&J.test(this.type)){this.checked=a.inArray(a3.val(),a5)>=0}else{if(a.nodeName(this,"select")){var a2=a.makeArray(a5);
a("option",this).each(function(){this.selected=a.inArray(a(this).val(),a2)>=0});if(!a2.length){this.selectedIndex=-1
}}else{this.value=a5}}})}});a.extend({attrFn:{val:true,css:true,html:true,text:true,data:true,width:true,height:true,offset:true},attr:function(aS,aR,aX,a0){if(!aS||aS.nodeType===3||aS.nodeType===8){return B
}if(a0&&aR in a.attrFn){return a(aS)[aR](aX)}var aT=aS.nodeType!==1||!a.isXMLDoc(aS),aW=aX!==B;
aR=aT&&a.props[aR]||aR;var aV=aH.test(aR);if(aR==="selected"&&!a.support.optSelected){var aY=aS.parentNode;
if(aY){aY.selectedIndex;if(aY.parentNode){aY.parentNode.selectedIndex}}}if((aR in aS||aS[aR]!==B)&&aT&&!aV){if(aW){if(aR==="type"&&c.test(aS.nodeName)&&aS.parentNode){a.error("type property can't be changed")
...
}if(aR==="tabIndex"){var aZ=aS.getAttributeNode("tabIndex");return aZ&&aZ.specified?aZ.value:w.test(aS.nodeName)||h.test(aS.nodeName)&&aS.href?0:B
}return aS[aR]}if(!a.support.style&&aT&&aR==="style"){if(aW){aS.style.cssText=""+aX
}return aS.style.cssText}if(aW){aS.setAttribute(aR,""+aX)}if(!aS.attributes[aR]&&(aS.hasAttribute&&!aS.hasAttribute(aR))){return B
}var aU=!a.support.hrefNormalized&&aT&&aV?aS.getAttribute(aR,2):aS.getAttribute(aR);
return aU===null?B:aU}});var av=/\.(.*)$/,aG=/^(?:textarea|input|select)$/i,D=/\./g,R=/ /g,af=/[^\w\s.|`]/g,y=function(aR){return aR.replace(af,"\\$&")
},x={focusin:0,focusout:0};a.event={add:function(aV,aZ,a5,aX){if(aV.nodeType===3||aV.nodeType===8){return
}if(a.isWindow(aV)&&(aV!==aE&&!aV.frameElement)){aV=aE}if(a5===false){a5=aJ}else{if(!a5){return
}}var aT,a3;if(a5.handler){aT=a5;a5=aT.handler}if(!a5.guid){a5.guid=a.guid++}var a0=a.data(aV);
if(!a0){return}var aR=aV.nodeType?"events":"__events__",a4=a0[aR],aY=a0.handle;if(typeof a4==="function"){aY=a4.handle;
a4=a4.events}else{if(!a4){if(!aV.nodeType){a0[aR]=a0=function(){}}a0.events=a4={}
...
if(a2.indexOf(".")>-1){aS=a2.split(".");a2=aS.shift();a3.namespace=aS.slice(0).sort().join(".")
}else{aS=[];a3.namespace=""}a3.type=a2;if(!a3.guid){a3.guid=a5.guid}var aU=a4[a2],a1=a.event.special[a2]||{};
if(!aU){aU=a4[a2]=[];if(!a1.setup||a1.setup.call(aV,aX,aS,aY)===false){if(aV.addEventListener){aV.addEventListener(a2,aY,false)
}else{if(aV.attachEvent){aV.attachEvent("on"+a2,aY)}}}}if(a1.add){a1.add.call(aV,a3);
if(!a3.handler.guid){a3.handler.guid=a5.guid}}aU.push(a3);a.event.global[a2]=true
}aV=null},global:{},remove:function(a7,a1,aT,aX){if(a7.nodeType===3||a7.nodeType===8){return
}if(aT===false){aT=aJ}var ba,aW,aY,a4,a5=0,aU,aZ,a2,aV,a0,aR,a9,a3=a7.nodeType?"events":"__events__",a6=a.data(a7),aS=a6&&a6[a3];
if(!a6||!aS){return}if(typeof aS==="function"){a6=aS;aS=aS.events}if(a1&&a1.type){aT=a1.handler;
a1=a1.type}if(!a1||typeof a1==="string"&&a1.charAt(0)==="."){a1=a1||"";for(aW in aS){a.event.remove(a7,aW+a1)
}return}a1=a1.split(" ");while((aW=a1[a5++])){a9=aW;aR=null;aU=aW.indexOf(".")<0;
aZ=[];if(!aU){aZ=aW.split(".");aW=aZ.shift();a2=new RegExp("(^|\\.)"+a.map(aZ.slice(0).sort(),y).join("\\.(?:.*\\.)?")+"(\\.|$)")
}a0=aS[aW];if(!a0){continue}if(!aT){for(a4=0;a4<a0.length;a4++){aR=a0[a4];if(aU||a2.test(aR.namespace)){a.event.remove(a7,a9,aR.handler,a4);
a0.splice(a4--,1)}}continue}aV=a.event.special[aW]||{};for(a4=aX||0;a4<a0.length;
a4++){aR=a0[a4];if(aT.guid===aR.guid){if(aU||a2.test(aR.namespace)){if(aX==null){a0.splice(a4--,1)
...
}ba=null;delete aS[aW]}}if(a.isEmptyObject(aS)){var a8=a6.handle;if(a8){a8.elem=null
}delete a6.events;delete a6.handle;if(typeof a6==="function"){a.removeData(a7,a3)
}else{if(a.isEmptyObject(a6)){a.removeData(a7)}}}},trigger:function(aS,aX,aU){var a1=aS.type||aS,aW=arguments[3];
if(!aW){aS=typeof aS==="object"?aS[a.expando]?aS:a.extend(a.Event(a1),aS):a.Event(a1);
if(a1.indexOf("!")>=0){aS.type=a1=a1.slice(0,-1);aS.exclusive=true}if(!aU){aS.stopPropagation();
if(a.event.global[a1]){a.each(a.cache,function(){if(this.events&&this.events[a1]){a.event.trigger(aS,aX,this.handle.elem)
}})}}if(!aU||aU.nodeType===3||aU.nodeType===8){return B}aS.result=B;aS.target=aU;
aX=a.makeArray(aX);aX.unshift(aS)}aS.currentTarget=aU;var aY=aU.nodeType?a.data(aU,"handle"):(a.data(aU,"__events__")||{}).handle;
...
aS.preventDefault()}}}catch(a2){}if(!aS.isPropagationStopped()&&a3){a.event.trigger(aS,aX,a3,true)
...
if(aT){aZ["on"+aR]=null}a.event.triggered=true;aZ[aR]()}}catch(aV){}if(aT){aZ["on"+aR]=aT
}a.event.triggered=false}}}},handle:function(aR){var a0,aT,aS,a2,a1,aW=[],aY=a.makeArray(arguments);
aR=aY[0]=a.event.fix(aR||aE.event);aR.currentTarget=this;a0=aR.type.indexOf(".")<0&&!aR.exclusive;
if(!a0){aS=aR.type.split(".");aR.type=aS.shift();aW=aS.slice(0).sort();a2=new RegExp("(^|\\.)"+aW.join("\\.(?:.*\\.)?")+"(\\.|$)")
}aR.namespace=aR.namespace||aW.join(".");a1=a.data(this,this.nodeType?"events":"__events__");
if(typeof a1==="function"){a1=a1.events}aT=(a1||{})[aR.type];if(a1&&aT){aT=aT.slice(0);
for(var aV=0,aU=aT.length;aV<aU;aV++){var aZ=aT[aV];if(a0||a2.test(aZ.namespace)){aR.handler=aZ.handler;
aR.data=aZ.data;aR.handleObj=aZ;var aX=aZ.handler.apply(this,aY);if(aX!==B){aR.result=aX;
if(aX===false){aR.preventDefault();aR.stopPropagation()}}if(aR.isImmediatePropagationStopped()){break
}}}}return aR.result},props:"altKey attrChange attrName bubbles button cancelable charCode clientX clientY ctrlKey currentTarget data detail eventPhase fromElement handler keyCode layerX layerY metaKey newValue offsetX offsetY pageX pageY prevValue relatedNode relatedTarget screenX screenY shiftKey srcElement target toElement view wheelDelta which".split(" "),fix:function(aU){if(aU[a.expando]){return aU
}var aS=aU;aU=a.Event(aS);for(var aT=this.props.length,aW;aT;){aW=this.props[--aT];
aU[aW]=aS[aW]}if(!aU.target){aU.target=aU.srcElement||aa}if(aU.target.nodeType===3){aU.target=aU.target.parentNode
...
}return aU},guid:100000000,proxy:a.proxy,special:{ready:{setup:a.bindReady,teardown:a.noop},live:{add:function(aR){a.event.add(this,k(aR.origType,aR.selector),a.extend({},aR,{handler:U,guid:aR.handler.guid}))
},remove:function(aR){a.event.remove(this,k(aR.origType,aR.selector),aR)}},beforeunload:{setup:function(aT,aS,aR){if(a.isWindow(this)){this.onbeforeunload=aR
...
}if(aR&&aR.type){this.originalEvent=aR;this.type=aR.type}else{this.type=aR}this.timeStamp=a.now();
this[a.expando]=true};function aJ(){return false}function e(){return true}a.Event.prototype={preventDefault:function(){this.isDefaultPrevented=e;
var aR=this.originalEvent;if(!aR){return}if(aR.preventDefault){aR.preventDefault()
}else{aR.returnValue=false}},stopPropagation:function(){this.isPropagationStopped=e;
var aR=this.originalEvent;if(!aR){return}if(aR.stopPropagation){aR.stopPropagation()
}aR.cancelBubble=true},stopImmediatePropagation:function(){this.isImmediatePropagationStopped=e;
this.stopPropagation()},isDefaultPrevented:aJ,isPropagationStopped:aJ,isImmediatePropagationStopped:aJ};
var Q=function(aS){var aR=aS.relatedTarget;try{while(aR&&aR!==this){aR=aR.parentNode
}if(aR!==this){aS.type=aS.data;a.event.handle.apply(this,arguments)}}catch(aT){}},ap=function(aR){aR.type=aR.data;
a.event.handle.apply(this,arguments)};a.each({mouseenter:"mouseover",mouseleave:"mouseout"},function(aS,aR){a.event.special[aS]={setup:function(aT){a.event.add(this,aR,aT&&aT.selector?ap:Q,aS)
...
}}}if(!a.support.changeBubbles){var aK,g=function(aS){var aR=aS.type,aT=aS.value;
if(aR==="radio"||aR==="checkbox"){aT=aS.checked}else{if(aR==="select-multiple"){aT=aS.selectedIndex>-1?a.map(aS.options,function(aU){return aU.selected
}).join("-"):""}else{if(aS.nodeName.toLowerCase()==="select"){aT=aS.selectedIndex
}}}return aT},O=function O(aT){var aR=aT.target,aS,aU;if(!aG.test(aR.nodeName)||aR.readOnly){return
}aS=a.data(aR,"_change_data");aU=g(aR);if(aT.type!=="focusout"||aR.type!=="radio"){a.data(aR,"_change_data",aU)
...
}},keydown:function(aT){var aS=aT.target,aR=aS.type;if((aT.keyCode===13&&aS.nodeName.toLowerCase()!=="textarea")||(aT.keyCode===32&&(aR==="checkbox"||aR==="radio"))||aR==="select-multiple"){return O.call(this,aT)
}},beforeactivate:function(aS){var aR=aS.target;a.data(aR,"_change_data",g(aR))}},setup:function(aT,aS){if(this.type==="file"){return false
}for(var aR in aK){a.event.add(this,aR+".specialChange",aK[aR])}return aG.test(this.nodeName)
},teardown:function(aR){a.event.remove(this,".specialChange");return aG.test(this.nodeName)
}};aK=a.event.special.change.filters;aK.focus=aK.beforeactivate}function at(aS,aT,aR){aR[0].type=aS;
...
return aX.apply(this,arguments)}):aX;if(aY==="unload"&&aR!=="one"){this.one(aY,aZ,aX)
}else{for(var aU=0,aT=this.length;aU<aT;aU++){a.event.add(this[aU],aY,aW,aZ)}}return this
}});a.fn.extend({unbind:function(aV,aU){if(typeof aV==="object"&&!aV.preventDefault){for(var aT in aV){this.unbind(aT,aV[aT])
}}else{for(var aS=0,aR=this.length;aS<aR;aS++){a.event.remove(this[aS],aV,aU)}}return this
},delegate:function(aR,aS,aU,aT){return this.live(aS,aU,aT,aR)},undelegate:function(aR,aS,aT){if(arguments.length===0){return this.unbind("live")
}else{return this.die(aS,null,aT,aR)}},trigger:function(aR,aS){return this.each(function(){a.event.trigger(aR,aS,this)
})},triggerHandler:function(aR,aT){if(this[0]){var aS=a.Event(aR);aS.preventDefault();
aS.stopPropagation();a.event.trigger(aS,aT,this[0]);return aS.result}},toggle:function(aT){var aR=arguments,aS=1;
...
}return this}if(a.isFunction(aZ)){a4=aZ;aZ=B}a2=(a2||"").split(" ");while((a3=a2[a0++])!=null){a1=av.exec(a3);
aU="";if(a1){aU=a1[0];a3=a3.replace(av,"")}if(a3==="hover"){a2.push("mouseenter"+aU,"mouseleave"+aU);
continue}a6=a3;if(a3==="focus"||a3==="blur"){a2.push(ao[a3]+aU);a3=a3+aU}else{a3=(ao[a3]||a3)+aU
}if(aR==="live"){for(var aY=0,aW=aT.length;aY<aW;aY++){a.event.add(aT[aY],"live."+k(a3,aX),{data:aZ,selector:aX,handler:a4,origType:a3,origHandler:a4,preType:a6})
}}else{aT.unbind("live."+k(a3,aX),a4)}}return this}});function U(a2){var aZ,aU,a8,aW,aR,a4,a1,a3,a0,a7,aY,aX,a6,a5=[],aV=[],aS=a.data(this,this.nodeType?"events":"__events__");
...
}a2.liveFired=this;var aT=aS.live.slice(0);for(a1=0;a1<aT.length;a1++){aR=aT[a1];
if(aR.origType.replace(av,"")===a2.type){aV.push(aR.selector)}else{aT.splice(a1--,1)
}}aW=a(a2.target).closest(aV,a2.currentTarget);for(a3=0,a0=aW.length;a3<a0;a3++){aY=aW[a3];
for(a1=0;a1<aT.length;a1++){aR=aT[a1];if(aY.selector===aR.selector&&(!aX||aX.test(aR.namespace))){a4=aY.elem;
a8=null;if(aR.preType==="mouseenter"||aR.preType==="mouseleave"){a2.type=aR.preType;
a8=a(a2.relatedTarget).closest(aR.selector)[0]}if(!a8||a8!==a4){a5.push({elem:a4,handleObj:aR,level:aY.level})
}}}}for(a3=0,a0=a5.length;a3<a0;a3++){aW=a5[a3];if(aU&&aW.level>aU){break}a2.currentTarget=aW.elem;
a2.data=aW.handleObj.data;a2.handleObj=aW.handleObj;a6=aW.handleObj.origHandler.apply(aW.elem,arguments);
if(a6===false||a2.isPropagationStopped()){aU=aW.level;if(a6===false){aZ=false}if(a2.isImmediatePropagationStopped()){break
}}}return aZ}function k(aS,aR){return(aS&&aS!=="*"?aS+".":"")+aR.replace(D,"`").replace(R,"&")
...
[0,0].sort(function(){aY=false;return 0});var aS=function(bd,a8,bg,bh){bg=bg||[];
a8=a8||aa;var bj=a8;if(a8.nodeType!==1&&a8.nodeType!==9){return[]}if(!bd||typeof bd!=="string"){return bg
}var ba,bl,bo,a9,bk,bn,bm,bf,bc=true,bb=aS.isXML(a8),be=[],bi=bd;do{a6.exec("");ba=a6.exec(bi);
if(ba){bi=ba[3];be.push(ba[1]);if(ba[2]){a9=ba[3];break}}}while(ba);if(be.length>1&&a0.exec(bd)){if(be.length===2&&aV.relative[be[0]]){bl=aX(be[0]+be[1],a8)
}else{bl=aV.relative[be[0]]?[a8]:aS(be.shift(),a8);while(be.length){bd=be.shift();
if(aV.relative[bd]){bd+=be.shift()}bl=aX(bd,bl)}}}else{if(!bh&&be.length>1&&a8.nodeType===9&&!bb&&aV.match.ID.test(be[0])&&!aV.match.ID.test(be[be.length-1])){bk=aS.find(be.shift(),a8,bb);
...
bl=bk.expr?aS.filter(bk.expr,bk.set):bk.set;if(be.length>0){bo=aR(bl)}else{bc=false
}while(be.length){bn=be.pop();bm=bn;if(!aV.relative[bn]){bn=""}else{bm=be.pop()}if(bm==null){bm=a8
}aV.relative[bn](bo,bm,bb)}}else{bo=be=[]}}if(!bo){bo=bl}if(!bo){aS.error(bn||bd)
}if(aU.call(bo)==="[object Array]"){if(!bc){bg.push.apply(bg,bo)}else{if(a8&&a8.nodeType===1){for(bf=0;
bo[bf]!=null;bf++){if(bo[bf]&&(bo[bf]===true||bo[bf].nodeType===1&&aS.contains(a8,bo[bf]))){bg.push(bl[bf])
}}}else{for(bf=0;bo[bf]!=null;bf++){if(bo[bf]&&bo[bf].nodeType===1){bg.push(bl[bf])
}}}}}else{aR(bo,bg)}if(a9){aS(a9,bj,bg,bh);aS.uniqueSort(bg)}return bg};aS.uniqueSort=function(a9){if(aT){a5=aY;
a9.sort(aT);if(a5){for(var a8=1;a8<a9.length;a8++){if(a9[a8]===a9[a8-1]){a9.splice(a8--,1)
}}}}return a9};aS.matches=function(a8,a9){return aS(a8,null,null,a9)};aS.matchesSelector=function(a8,a9){return aS(a9,null,null,[a8]).length>0
};aS.find=function(bf,a8,bg){var be;if(!bf){return[]}for(var bb=0,ba=aV.order.length;
bb<ba;bb++){var bc,bd=aV.order[bb];if((bc=aV.leftMatch[bd].exec(bf))){var a9=bc[1];
bc.splice(1,1);if(a9.substr(a9.length-1)!=="\\"){bc[1]=(bc[1]||"").replace(/\\/g,"");
be=aV.find[bd](bc,a8,bg);if(be!=null){bf=bf.replace(aV.match[bd],"");break}}}}if(!be){be=a8.getElementsByTagName("*")
}return{set:be,expr:bf}};aS.filter=function(bj,bi,bm,bc){var be,a8,ba=bj,bo=[],bg=bi,bf=bi&&bi[0]&&aS.isXML(bi[0]);
while(bj&&bi.length){for(var bh in aV.filter){if((be=aV.leftMatch[bh].exec(bj))!=null&&be[2]){var bn,bl,a9=aV.filter[bh],bb=be[1];
a8=false;be.splice(1,1);if(bb.substr(bb.length-1)==="\\"){continue}if(bg===bo){bo=[]
}if(aV.preFilter[bh]){be=aV.preFilter[bh](be,bg,bm,bo,bc,bf);if(!be){a8=bn=true}else{if(be===true){continue
}}}if(be){for(var bd=0;(bl=bg[bd])!=null;bd++){if(bl){bn=a9(bl,be,bd,bg);var bk=bc^!!bn;
if(bm&&bn!=null){if(bk){a8=true}else{bg[bd]=false}}else{if(bk){bo.push(bl);a8=true
}}}}}if(bn!==B){if(!bm){bg=bo}bj=bj.replace(aV.match[bh],"");if(!a8){return[]}break
}}}if(bj===ba){if(a8==null){aS.error(bj)}else{break}}ba=bj}return bg};aS.error=function(a8){throw"Syntax error, unrecognized expression: "+a8
...
if(bd){a9=a9.toLowerCase()}for(var ba=0,a8=be.length,bc;ba<a8;ba++){if((bc=be[ba])){while((bc=bc.previousSibling)&&bc.nodeType!==1){}be[ba]=bf||bc&&bc.nodeName.toLowerCase()===a9?bc||false:bc===a9
}}if(bf){aS.filter(a9,be,true)}},">":function(be,a9){var bd,bc=typeof a9==="string",ba=0,a8=be.length;
if(bc&&!/\W/.test(a9)){a9=a9.toLowerCase();for(;ba<a8;ba++){bd=be[ba];if(bd){var bb=bd.parentNode;
be[ba]=bb.nodeName.toLowerCase()===a9?bb:false}}}else{for(;ba<a8;ba++){bd=be[ba];
if(bd){be[ba]=bc?bd.parentNode:bd.parentNode===a9}}if(bc){aS.filter(a9,be,true)}}},"":function(bb,a9,bd){var bc,ba=aZ++,a8=a7;
if(typeof a9==="string"&&!/\W/.test(a9)){a9=a9.toLowerCase();bc=a9;a8=a4}a8("parentNode",a9,ba,bb,bc,bd)
...
for(var bb=0,a8=bc.length;bb<a8;bb++){if(bc[bb].getAttribute("name")===ba[1]){a9.push(bc[bb])
}}return a9.length===0?null:a9}},TAG:function(a8,a9){return a9.getElementsByTagName(a8[1])
...
}}else{if(ba){a9[bc]=false}}}}return false},ID:function(a8){return a8[1].replace(/\\/g,"")
},TAG:function(a9,a8){return a9[1].toLowerCase()},CHILD:function(a8){if(a8[1]==="nth"){var a9=/(-?)(\d*)n((?:\+|-)?\d*)/.exec(a8[2]==="even"&&"2n"||a8[2]==="odd"&&"2n+1"||!/\D/.test(a8[2])&&"0n+"+a8[2]||a8[2]);
a8[2]=(a9[1]+(a9[2]||1))-0;a8[3]=a9[3]-0}a8[0]=aZ++;return a8},ATTR:function(bc,a9,ba,a8,bd,be){var bb=bc[1].replace(/\\/g,"");
if(!be&&aV.attrMap[bb]){bc[1]=aV.attrMap[bb]}if(bc[2]==="~="){bc[4]=" "+bc[4]+" "
}return bc},PSEUDO:function(bc,a9,ba,a8,bd){if(bc[1]==="not"){if((a6.exec(bc[3])||"").length>1||/^\w/.test(bc[3])){bc[3]=aS(bc[3],null,null,a9)
}else{var bb=aS.filter(bc[3],a9,ba,true^bd);if(!ba){a8.push.apply(a8,bb)}return false
}}else{if(aV.match.POS.test(bc[0])||aV.match.CHILD.test(bc[0])){return true}}return bc
},POS:function(a8){a8.unshift(true);return a8}},filters:{enabled:function(a8){return a8.disabled===false&&a8.type!=="hidden"
},disabled:function(a8){return a8.disabled===true},checked:function(a8){return a8.checked===true
},selected:function(a8){a8.parentNode.selectedIndex;return a8.selected===true},parent:function(a8){return !!a8.firstChild
},empty:function(a8){return !a8.firstChild},has:function(ba,a9,a8){return !!aS(a8[3],ba).length
},header:function(a8){return(/h\d/i).test(a8.nodeName)},text:function(a8){return"text"===a8.type
},radio:function(a8){return"radio"===a8.type},checkbox:function(a8){return"checkbox"===a8.type
},file:function(a8){return"file"===a8.type},password:function(a8){return"password"===a8.type
},submit:function(a8){return"submit"===a8.type},image:function(a8){return"image"===a8.type
},reset:function(a8){return"reset"===a8.type},button:function(a8){return"button"===a8.type||a8.nodeName.toLowerCase()==="button"
},input:function(a8){return(/input|select|textarea|button/i).test(a8.nodeName)}},setFilters:{first:function(a9,a8){return a8===0
},last:function(ba,a9,a8,bb){return a9===bb.length-1},even:function(a9,a8){return a8%2===0
},odd:function(a9,a8){return a8%2===1},lt:function(ba,a9,a8){return a9<a8[3]-0},gt:function(ba,a9,a8){return a9>a8[3]-0
},nth:function(ba,a9,a8){return a8[3]-0===a9},eq:function(ba,a9,a8){return a8[3]-0===a9
}},filter:{PSEUDO:function(ba,bf,be,bg){var a8=bf[1],a9=aV.filters[a8];if(a9){return a9(ba,be,bf,bg)
...
}}if(be==="first"){return true}a9=a8;case"last":while((a9=a9.nextSibling)){if(a9.nodeType===1){return false
}}return true;case"nth":var ba=bb[2],bh=bb[3];if(ba===1&&bh===0){return true}var bd=bb[0],bg=a8.parentNode;
if(bg&&(bg.sizcache!==bd||!a8.nodeIndex)){var bc=0;for(a9=bg.firstChild;a9;a9=a9.nextSibling){if(a9.nodeType===1){a9.nodeIndex=++bc
}}bg.sizcache=bd}var bf=a8.nodeIndex-bh;if(ba===0){return bf===0}else{return(bf%ba===0&&bf/ba>=0)
}}},ID:function(a9,a8){return a9.nodeType===1&&a9.getAttribute("id")===a8},TAG:function(a9,a8){return(a8==="*"&&a9.nodeType===1)||a9.nodeName.toLowerCase()===a8
...
},POS:function(bc,a9,ba,bd){var a8=a9[2],bb=aV.setFilters[a8];if(bb){return bb(bc,ba,a9,bd)
}}}};var a0=aV.match.POS,aW=function(a9,a8){return"\\"+(a8-0+1)};for(var a3 in aV.match){aV.match[a3]=new RegExp(aV.match[a3].source+(/(?![^\[]*\])(?![^\(]*\))/.source));
aV.leftMatch[a3]=new RegExp(/(^(?:.|\r|\n)*?)/.source+aV.match[a3].source.replace(/\\(\d+)/g,aW))
}var aR=function(a9,a8){a9=Array.prototype.slice.call(a9,0);if(a8){a8.push.apply(a8,a9);
return a8}return a9};try{Array.prototype.slice.call(aa.documentElement.childNodes,0)[0].nodeType
}catch(a1){aR=function(bc,bb){var ba=0,a9=bb||[];if(aU.call(bc)==="[object Array]"){Array.prototype.push.apply(a9,bc)
}else{if(typeof bc.length==="number"){for(var a8=bc.length;ba<a8;ba++){a9.push(bc[ba])
}}else{for(;bc[ba];ba++){a9.push(bc[ba])}}}return a9}}var aT,a2;if(aa.documentElement.compareDocumentPosition){aT=function(a9,a8){if(a9===a8){a5=true;
...
if(bg===bf){a5=true;return 0}else{if(bc===be){return a2(bg,bf)}else{if(!bc){return -1
}else{if(!be){return 1}}}}while(bh){ba.unshift(bh);bh=bh.parentNode}bh=be;while(bh){a8.unshift(bh);
bh=bh.parentNode}bd=ba.length;a9=a8.length;for(var bb=0;bb<bd&&bb<a9;bb++){if(ba[bb]!==a8[bb]){return a2(ba[bb],a8[bb])
}}return bb===bd?a2(bg,a8[bb],-1):a2(ba[bb],bf,1)};a2=function(a9,a8,ba){if(a9===a8){return ba
}var bb=a9.nextSibling;while(bb){if(bb===a8){return -1}bb=bb.nextSibling}return 1
}}aS.getText=function(a8){var a9="",bb;for(var ba=0;a8[ba];ba++){bb=a8[ba];if(bb.nodeType===3||bb.nodeType===4){a9+=bb.nodeValue
}else{if(bb.nodeType!==8){a9+=aS.getText(bb.childNodes)}}}return a9};(function(){var a9=aa.createElement("div"),ba="script"+(new Date()).getTime(),a8=aa.documentElement;
...
return bd.nodeType===1&&bc&&bc.nodeValue===bb}}a8.removeChild(a9);a8=a9=null})();
(function(){var a8=aa.createElement("div");a8.appendChild(aa.createComment(""));if(a8.getElementsByTagName("*").length>0){aV.find.TAG=function(a9,bd){var bc=bd.getElementsByTagName(a9[1]);
if(a9[1]==="*"){var bb=[];for(var ba=0;bc[ba];ba++){if(bc[ba].nodeType===1){bb.push(bc[ba])
}}bc=bb}return bc}}a8.innerHTML="<a href='#'></a>";if(a8.firstChild&&typeof a8.firstChild.getAttribute!=="undefined"&&a8.firstChild.getAttribute("href")!=="#"){aV.attrHandle.href=function(a9){return a9.getAttribute("href",2)
...
}aS=function(bg,bf,bc,be){bf=bf||aa;bg=bg.replace(/\=\s*([^'"\]]*)\s*\]/g,"='$1']");
...
if(!bd){bf.setAttribute("id",bj)}try{return aR(bf.querySelectorAll("#"+bj+" "+bg),bc)
}catch(bh){}finally{if(!bd){bf.removeAttribute("id")}}}}}return a8(bg,bf,bc,be)};
for(var a9 in a8){aS[a9]=a8[a9]}bb=null})()}(function(){var a8=aa.documentElement,ba=a8.matchesSelector||a8.mozMatchesSelector||a8.webkitMatchesSelector||a8.msMatchesSelector,a9=false;
...
}}catch(bd){}}return aS(be,null,null,[bc]).length>0}}})();(function(){var a8=aa.createElement("div");
a8.innerHTML="<div class='test e'></div><div class='test'></div>";if(!a8.getElementsByClassName||a8.getElementsByClassName("e").length===0){return
}a8.lastChild.className="e";if(a8.getElementsByClassName("e").length===1){return}aV.order.splice(1,0,"CLASS");
aV.find.CLASS=function(a9,ba,bb){if(typeof ba.getElementsByClassName!=="undefined"&&!bb){return ba.getElementsByClassName(a9[1])
}};a8=null})();function a4(a9,be,bd,bh,bf,bg){for(var bb=0,ba=bh.length;bb<ba;bb++){var a8=bh[bb];
if(a8){var bc=false;a8=a8[a9];while(a8){if(a8.sizcache===bd){bc=bh[a8.sizset];break
}if(a8.nodeType===1&&!bg){a8.sizcache=bd;a8.sizset=bb}if(a8.nodeName.toLowerCase()===be){bc=a8;
break}a8=a8[a9]}bh[bb]=bc}}}function a7(a9,be,bd,bh,bf,bg){for(var bb=0,ba=bh.length;
...
for(var be=0,a9=ba.length;be<a9;be++){aS(a8,ba[be],bb)}return aS.filter(bc,bb)};a.find=aS;
a.expr=aS.selectors;a.expr[":"]=a.expr.filters;a.unique=aS.uniqueSort;a.text=aS.getText;
a.isXMLDoc=aS.isXML;a.contains=aS.contains})();var N=/Until$/,X=/^(?:parents|prevUntil|prevAll)/,aC=/,/,aO=/^.[^:#\[\.,]*$/,F=Array.prototype.slice,z=a.expr.match.POS;
a.fn.extend({find:function(aR){var aT=this.pushStack("","find",aR),aW=0;for(var aU=0,aS=this.length;
aU<aS;aU++){aW=aT.length;a.find(aR,this[aU],aT);if(aU>0){for(var aX=aW;aX<aT.length;
aX++){for(var aV=0;aV<aW;aV++){if(aT[aV]===aT[aX]){aT.splice(aX--,1);break}}}}}return aT
},has:function(aS){var aR=a(aS);return this.filter(function(){for(var aU=0,aT=aR.length;
...
},closest:function(a1,aS){var aY=[],aV,aT,a0=this[0];if(a.isArray(a1)){var aX,aU,aW={},aR=1;
if(a0&&a1.length){for(aV=0,aT=a1.length;aV<aT;aV++){aU=a1[aV];if(!aW[aU]){aW[aU]=a.expr.match.POS.test(aU)?a(aU,aS||this.context):aU
}}while(a0&&a0.ownerDocument&&a0!==aS){for(aU in aW){aX=aW[aU];if(aX.jquery?aX.index(a0)>-1:a(a0).is(aX)){aY.push({selector:aU,elem:a0,level:aR})
}}a0=a0.parentNode;aR++}}return aY}var aZ=z.test(a1)?a(a1,aS||this.context):null;
for(aV=0,aT=this.length;aV<aT;aV++){a0=this[aV];while(a0){if(aZ?aZ.index(a0)>-1:a.find.matchesSelector(a0,a1)){aY.push(a0);
break}else{a0=a0.parentNode;if(!a0||!a0.ownerDocument||a0===aS){break}}}}aY=aY.length>1?a.unique(aY):aY;
return this.pushStack(aY,"closest",a1)},index:function(aR){if(!aR||typeof aR==="string"){return a.inArray(this[0],aR?a(aR):this.parent().children())
...
return aR&&aR.nodeType!==11?aR:null},parents:function(aR){return a.dir(aR,"parentNode")
},parentsUntil:function(aS,aR,aT){return a.dir(aS,"parentNode",aT)},next:function(aR){return a.nth(aR,2,"nextSibling")
},prev:function(aR){return a.nth(aR,2,"previousSibling")},nextAll:function(aR){return a.dir(aR,"nextSibling")
},prevAll:function(aR){return a.dir(aR,"previousSibling")},nextUntil:function(aS,aR,aT){return a.dir(aS,"nextSibling",aT)
},prevUntil:function(aS,aR,aT){return a.dir(aS,"previousSibling",aT)},siblings:function(aR){return a.sibling(aR.parentNode.firstChild,aR)
},children:function(aR){return a.sibling(aR.firstChild)},contents:function(aR){return a.nodeName(aR,"iframe")?aR.contentDocument||aR.contentWindow.document:a.makeArray(aR.childNodes)
}},function(aR,aS){a.fn[aR]=function(aV,aT){var aU=a.map(this,aS,aV);if(!N.test(aR)){aT=aV
}if(aT&&typeof aT==="string"){aU=a.filter(aT,aU)}aU=this.length>1?a.unique(aU):aU;
if((this.length>1||aC.test(aT))&&X.test(aR)){aU=aU.reverse()}return this.pushStack(aU,aR,F.call(arguments).join(","))
...
return aX===aR})}else{if(aT.nodeType){return a.grep(aU,function(aW,aV){return(aW===aT)===aR
...
if(!a.support.htmlSerialize){ab._default=[1,"div<div>","</div>"]}a.fn.extend({text:function(aR){if(a.isFunction(aR)){return this.each(function(aT){var aS=a(this);
aS.text(aR.call(this,aT,aS.text()))})}if(typeof aR!=="object"&&aR!==B){return this.empty().append((this[0]&&this[0].ownerDocument||aa).createTextNode(aR))
...
}aS.map(function(){var aT=this;while(aT.firstChild&&aT.firstChild.nodeType===1){aT=aT.firstChild
}return aT}).append(this)}return this},wrapInner:function(aR){if(a.isFunction(aR)){return this.each(function(aS){a(this).wrapInner(aR.call(this,aS))
})}return this.each(function(){var aS=a(this),aT=aS.contents();if(aT.length){aT.wrapAll(aR)
}else{aS.append(aR)}})},wrap:function(aR){return this.each(function(){a(this).wrapAll(aR)
...
})}else{if(arguments.length){var aR=a(arguments[0]);aR.push.apply(aR,this.toArray());
return this.pushStack(aR,"before",arguments)}}},after:function(){if(this[0]&&this[0].parentNode){return this.domManip(arguments,false,function(aS){this.parentNode.insertBefore(aS,this.nextSibling)
...
(aS=this[aR])!=null;aR++){if(aS.nodeType===1){a.cleanData(aS.getElementsByTagName("*"))
}while(aS.firstChild){aS.removeChild(aS.firstChild)}}return this},clone:function(aS){var aR=this.map(function(){if(!a.support.noCloneEvent&&!a.isXMLDoc(this)){var aU=this.outerHTML,aT=this.ownerDocument;
if(!aU){var aV=aT.createElement("div");aV.appendChild(this.cloneNode(true));aU=aV.innerHTML
}return a.clean([aU.replace(S,"").replace(H,'="$1">').replace(Y,"")],aT)[0]}else{return this.cloneNode(true)
}});if(aS===true){n(this,aR);n(this.find("*"),aR.find("*"))}return aR},html:function(aT){if(aT===B){return this[0]&&this[0].nodeType===1?this[0].innerHTML.replace(S,""):null
...
}else{aV=aW.firstChild}if(aV){a1=a1&&a.nodeName(aV,"tr");for(var aT=0,aR=this.length;
aT<aR;aT++){a0.call(a1?aD(this[aT],aV):this[aT],aT>0||aU.cacheable||this.length>1?aW.cloneNode(true):aW)
...
}function n(aT,aR){var aS=0;aR.each(function(){if(this.nodeName!==(aT[aS]&&aT[aS].nodeName)){return
}var aY=a.data(aT[aS++]),aX=a.data(this,aY),aU=aY&&aY.events;if(aU){delete aX.handle;
aX.events={};for(var aW in aU){for(var aV in aU[aW]){a.event.add(this,aW,aU[aW][aV],aU[aW][aV].data)
...
aT=a.fragments[aW[0]];if(aT){if(aT!==1){aV=aT}}}if(!aV){aV=aX.createDocumentFragment();
a.clean(aW,aX,aV,aS)}if(aR){a.fragments[aW[0]]=aT?aV:1}return{fragment:aV,cacheable:aR}
};a.fragments={};a.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(aR,aS){a.fn[aR]=function(aT){var aW=[],aZ=a(aT),aY=this.length===1&&this[0].parentNode;
if(aY&&aY.nodeType===11&&aY.childNodes.length===1&&aZ.length===1){aZ[aS](this[0]);
return this}else{for(var aX=0,aU=aZ.length;aX<aU;aX++){var aV=(aX>0?this.clone(true):this).get();
a(aZ[aX])[aS](aV);aW=aW.concat(aV)}return this.pushStack(aW,aR,aZ.selector)}}});a.extend({clean:function(aT,aV,a2,aX){aV=aV||aa;
if(typeof aV.createElement==="undefined"){aV=aV.ownerDocument||aV[0]&&aV[0].ownerDocument||aa
}var a3=[];for(var a1=0,aW;(aW=aT[a1])!=null;a1++){if(typeof aW==="number"){aW+=""
}if(!aW){continue}if(typeof aW==="string"&&!L.test(aW)){aW=aV.createTextNode(aW)}else{if(typeof aW==="string"){aW=aW.replace(I,"<$1></$2>");
var a4=(b.exec(aW)||["",""])[1].toLowerCase(),aU=ab[a4]||ab._default,a0=aU[0],aS=aV.createElement("div");
aS.innerHTML=aU[1]+aW+aU[2];while(a0--){aS=aS.lastChild}if(!a.support.tbody){var aR=q.test(aW),aZ=a4==="table"&&!aR?aS.firstChild&&aS.firstChild.childNodes:aU[1]==="<table>"&&!aR?aS.childNodes:[];
...
}aW=aS.childNodes}}if(aW.nodeType){a3.push(aW)}else{a3=a.merge(a3,aW)}}if(a2){for(a1=0;
a3[a1];a1++){if(aX&&a.nodeName(a3[a1],"script")&&(!a3[a1].type||a3[a1].type.toLowerCase()==="text/javascript")){aX.push(a3[a1].parentNode?a3[a1].parentNode.removeChild(a3[a1]):a3[a1])
...
}}var T=/alpha\([^)]*\)/i,Z=/opacity=([^)]*)/,ar=/-([a-z])/ig,t=/([A-Z])/g,aF=/^-?\d+(?:px)?$/i,aM=/^-?\d/,aB={position:"absolute",visibility:"hidden",display:"block"},V=["Left","Right"],ax=["Top","Bottom"],M,ah,aq,i=function(aR,aS){return aS.toUpperCase()
...
return aR===""?"1":aR}else{return aT.style.opacity}}}},cssNumber:{zIndex:true,fontWeight:true,opacity:true,zoom:true,lineHeight:true},cssProps:{"float":a.support.cssFloat?"cssFloat":"styleFloat"},style:function(aT,aS,aY,aU){if(!aT||aT.nodeType===3||aT.nodeType===8||!aT.style){return
...
}catch(aW){}}}else{if(aZ&&"get" in aZ&&(aX=aZ.get(aT,false,aU))!==B){return aX}return aR[aS]
}},css:function(aW,aV,aS){var aU,aT=a.camelCase(aV),aR=a.cssHooks[aT];aV=a.cssProps[aT]||aT;
if(aR&&"get" in aR&&(aU=aR.get(aW,true,aS))!==B){return aU}else{if(M){return M(aW,aV,aT)
}}},swap:function(aU,aT,aV){var aR={};for(var aS in aT){aR[aS]=aU.style[aS];aU.style[aS]=aT[aS]
}aV.call(aU);for(aS in aT){aU.style[aS]=aR[aS]}},camelCase:function(aR){return aR.replace(ar,i)
}});a.curCSS=a.css;a.each(["height","width"],function(aS,aR){a.cssHooks[aR]={get:function(aV,aU,aT){var aW;
if(aU){if(aV.offsetWidth!==0){aW=l(aV,aR,aT)}else{a.swap(aV,aB,function(){aW=l(aV,aR,aT)
})}if(aW<=0){aW=M(aV,aR,aR);if(aW==="0px"&&aq){aW=aq(aV,aR,aR)}if(aW!=null){return aW===""||aW==="auto"?"0px":aW
}}if(aW<0||aW==null){aW=aV.style[aR];return aW===""||aW==="auto"?"0px":aW}return typeof aW==="string"?aW:aW+"px"
}},set:function(aT,aU){if(aF.test(aU)){aU=parseFloat(aU);if(aU>=0){return aU+"px"
...
aU=aU.replace(t,"-$1").toLowerCase();if(!(aV=aW.ownerDocument.defaultView)){return B
}if((aS=aV.getComputedStyle(aW,null))){aT=aS.getPropertyValue(aU);if(aT===""&&!a.contains(aW.ownerDocument.documentElement,aW)){aT=a.style(aW,aU)
}}return aT}}if(aa.documentElement.currentStyle){aq=function(aV,aT){var aW,aR,aS=aV.currentStyle&&aV.currentStyle[aT],aU=aV.style;
if(!aF.test(aS)&&aM.test(aS)){aW=aU.left;aR=aV.runtimeStyle.left;aV.runtimeStyle.left=aV.currentStyle.left;
aU.left=aT==="fontSize"?"1em":(aS||0);aS=aU.pixelLeft+"px";aU.left=aW;aV.runtimeStyle.left=aR
}return aS===""?"auto":aS}}M=ah||aq;function l(aT,aS,aR){var aV=aS==="width"?V:ax,aU=aS==="width"?aT.offsetWidth:aT.offsetHeight;
...
};a.expr.filters.visible=function(aR){return !a.expr.filters.hidden(aR)}}var ad=a.now(),aA=/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,m=/^(?:select|textarea)/i,au=/^(?:color|date|datetime|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i,ak=/^(?:GET|HEAD)$/,W=/\[\]$/,o=/\=\?(&|$)/,C=/\?/,aQ=/([?&])_=[^&]*/,A=/^(\w+:)?\/\/([^\/?#]+)/,f=/%20/g,aP=/#.*$/,u=a.fn.load;
a.fn.extend({load:function(aT,aW,aX){if(typeof aT!=="string"&&u){return u.apply(this,arguments)
}else{if(!this.length){return this}}var aV=aT.indexOf(" ");if(aV>=0){var aR=aT.slice(aV,aT.length);
aT=aT.slice(0,aV)}var aU="GET";if(aW){if(a.isFunction(aW)){aX=aW;aW=null}else{if(typeof aW==="object"){aW=a.param(aW,a.ajaxSettings.traditional);
aU="POST"}}}var aS=this;a.ajax({url:aT,type:aU,dataType:"html",data:aW,complete:function(aZ,aY){if(aY==="success"||aY==="notmodified"){aS.html(aR?a("<div>").append(aZ.responseText.replace(aA,"")).find(aR):aZ.responseText)
...
}});a.extend({get:function(aR,aT,aU,aS){if(a.isFunction(aT)){aS=aS||aU;aU=aT;aT=null
}return a.ajax({type:"GET",url:aR,data:aT,success:aU,dataType:aS})},getScript:function(aR,aS){return a.get(aR,null,aS,"script")
},getJSON:function(aR,aS,aT){return a.get(aR,aS,aT,"json")},post:function(aR,aT,aU,aS){if(a.isFunction(aT)){aS=aS||aU;
aU=aT;aT={}}return a.ajax({type:"POST",url:aR,data:aT,success:aU,dataType:aS})},ajaxSetup:function(aR){a.extend(a.ajaxSettings,aR)
...
}}a1.dataType="json"}if(a1.dataType==="json"&&(a1.data&&o.test(a1.data)||o.test(a1.url))){bc=a1.jsonpCallback||("jsonp"+ad++);
if(a1.data){a1.data=(a1.data+"").replace(o,"="+bc+"$1")}a1.url=a1.url.replace(o,"="+bc+"$1");
a1.dataType="script";var a5=aE[bc];aE[bc]=function(be){if(a.isFunction(a5)){a5(be)
}else{aE[bc]=B;try{delete aE[bc]}catch(bd){}}bb=be;a.handleSuccess(a1,aX,a7,bb);a.handleComplete(a1,aX,a7,bb);
if(aU){aU.removeChild(a9)}}}if(a1.dataType==="script"&&a1.cache===null){a1.cache=false
...
var a9=aa.createElement("script");if(a1.scriptCharset){a9.charset=a1.scriptCharset
}a9.src=a1.url;if(!bc){var a2=false;a9.onload=a9.onreadystatechange=function(){if(!a2&&(!this.readyState||this.readyState==="loaded"||this.readyState==="complete")){a2=true;
a.handleSuccess(a1,aX,a7,bb);a.handleComplete(a1,aX,a7,bb);a9.onload=a9.onreadystatechange=null;
if(aU&&a9.parentNode){aU.removeChild(a9)}}}}aU.insertBefore(a9,aU.firstChild);return B
}var aZ=false;var aX=a1.xhr();if(!aX){return}if(a1.username){aX.open(aT,a1.url,a1.async,a1.username,a1.password)
...
var be;if(a7==="success"){try{bb=a.httpData(aX,a1.dataType,a1)}catch(bf){a7="parsererror";
be=bf}}if(a7==="success"||a7==="notmodified"){if(!bc){a.handleSuccess(a1,aX,a7,bb)
...
}},a1.timeout)}try{aX.send(a4||a1.data==null?null:a1.data)}catch(aW){a.handleError(a1,aX,null,aW);
a.handleComplete(a1,aX,a7,bb)}if(!a1.async){a0()}return aX},param:function(aR,aT){var aS=[],aV=function(aW,aX){aX=a.isFunction(aX)?aX():aX;
aS[aS.length]=encodeURIComponent(aW)+"="+encodeURIComponent(aX)};if(aT===B){aT=a.ajaxSettings.traditional
}if(a.isArray(aR)||aR.jquery){a.each(aR,function(){aV(this.name,this.value)})}else{for(var aU in aR){p(aU,aR[aU],aT,aV)
}}return aS.join("&").replace(f,"+")}});function p(aS,aU,aR,aT){if(a.isArray(aU)&&aU.length){a.each(aU,function(aW,aV){if(aR||W.test(aS)){aT(aS,aV)
}else{p(aS+"["+(typeof aV==="object"||a.isArray(aV)?aW:"")+"]",aV,aR,aT)}})}else{if(!aR&&aU!=null&&typeof aU==="object"){if(a.isEmptyObject(aU)){aT(aS,"")
}else{a.each(aU,function(aW,aV){p(aS+"["+aW+"]",aV,aR,aT)})}}else{aT(aS,aU)}}}a.extend({active:0,lastModified:{},etag:{},handleError:function(aS,aU,aR,aT){if(aS.error){aS.error.call(aS.context,aU,aR,aT)
...
}else{if(aU==="script"||!aU&&aS.indexOf("javascript")>=0){a.globalEval(aV)}}}return aV
...
}if(aV===""&&a.css(aT,"display")==="none"){a.data(aT,"olddisplay",s(aT.nodeName))
}}for(aS=0;aS<aR;aS++){aT=this[aS];aV=aT.style.display;if(aV===""||aV==="none"){aT.style.display=a.data(aT,"olddisplay")||""
}}return this}},hide:function(aT,aW,aV){if(aT||aT===0){return this.animate(aw("hide",3),aT,aW,aV)
}else{for(var aS=0,aR=this.length;aS<aR;aS++){var aU=a.css(this[aS],"display");if(aU!=="none"){a.data(this[aS],"olddisplay",aU)
}}for(aS=0;aS<aR;aS++){this[aS].style.display="none"}return this}},_toggle:a.fn.toggle,toggle:function(aT,aS,aU){var aR=typeof aT==="boolean";
...
a(this)[aV?"show":"hide"]()})}else{this.animate(aw("toggle",3),aT,aS,aU)}}return this
...
for(a2 in aV){var aX=a.camelCase(a2);if(a2!==aX){aV[aX]=aV[a2];delete aV[a2];a2=aX
}if(aV[a2]==="hide"&&a0||aV[a2]==="show"&&!a0){return aY.complete.call(this)}if(aZ&&(a2==="height"||a2==="width")){aY.overflow=[this.style.overflow,this.style.overflowX,this.style.overflowY];
if(a.css(this,"display")==="inline"&&a.css(this,"float")==="none"){if(!a.support.inlineBlockNeedsLayout){this.style.display="inline-block"
}else{var a1=s(this.nodeName);if(a1==="inline"){this.style.display="inline-block"
}else{this.style.display="inline";this.style.zoom=1}}}}if(a.isArray(aV[a2])){(aY.specialEasing=aY.specialEasing||{})[a2]=aV[a2][1];
aV[a2]=aV[a2][0]}}if(aY.overflow!=null){this.style.overflow="hidden"}aY.curAnim=a.extend({},aV);
a.each(aV,function(a4,a8){var a7=new a.fx(aW,aY,a4);if(ac.test(a8)){a7[a8==="toggle"?a0?"show":"hide":a8](aV)
}else{var a6=am.exec(a8),a9=a7.cur()||0;if(a6){var a3=parseFloat(a6[2]),a5=a6[3]||"px";
if(a5!=="px"){a.style(aW,a4,(a3||1)+a5);a9=((a3||1)/a7.cur())*a9;a.style(aW,a4,a9+a5)
}if(a6[1]){a3=((a6[1]==="-="?-1:1)*a3)+a9}a7.custom(a9,a3,a5)}else{a7.custom(a9,a8,"")
}}});return true})},stop:function(aS,aR){var aT=a.timers;if(aS){this.queue([])}this.each(function(){for(var aU=aT.length-1;
aU>=0;aU--){if(aT[aU].elem===this){if(aR){aT[aU](true)}aT.splice(aU,1)}}});if(!aR){this.dequeue()
}return this}});function aw(aS,aR){var aT={};a.each(ag.concat.apply([],ag.slice(0,aR)),function(){aT[this]=aS
...
this.startTime=a.now();this.start=aW;this.end=aV;this.unit=aU||this.unit||"px";this.now=this.start;
this.pos=this.state=0;function aS(aX){return aR.step(aX)}aS.elem=this.elem;if(aS()&&a.timers.push(aS)&&!ay){ay=setInterval(aT.tick,aT.interval)
...
}}this.options.complete.call(this.elem)}return false}else{var aS=aZ-this.startTime;
this.state=aS/this.options.duration;var aX=this.options.specialEasing&&this.options.specialEasing[this.prop];
var aY=this.options.easing||(a.easing.swing?"swing":"linear");this.pos=a.easing[aX||aY](this.state,aS,0,1,this.options.duration);
this.now=this.start+((this.end-this.start)*this.pos);this.update()}return true}};
a.extend(a.fx,{tick:function(){var aS=a.timers;for(var aR=0;aR<aS.length;aR++){if(!aS[aR]()){aS.splice(aR--,1)
}}if(!aS.length){a.fx.stop()}},interval:13,stop:function(){clearInterval(ay);ay=null
...
}).length}}function s(aT){if(!G[aT]){var aR=a("<"+aT+">").appendTo("body"),aS=aR.css("display");
aR.remove();if(aS==="none"||aS===""){aS="block"}G[aT]=aS}return G[aT]}var K=/^t(?:able|d|h)$/i,P=/^(?:body|html)$/i;
if("getBoundingClientRect" in aa.documentElement){a.fn.offset=function(a4){var aU=this[0],aX;
if(a4){return this.each(function(a5){a.offset.setOffset(this,a4,a5)})}if(!aU||!aU.ownerDocument){return null
}if(aU===aU.ownerDocument.body){return a.offset.bodyOffset(aU)}try{aX=aU.getBoundingClientRect()
}catch(a1){}var a3=aU.ownerDocument,aS=a3.documentElement;if(!aX||!a.contains(aS,aU)){return aX||{top:0,left:0}
...
}aZ=aY?aY.getComputedStyle(aW,null):aW.currentStyle;a0-=aW.scrollTop;aV-=aW.scrollLeft;
if(aW===aT){a0+=aW.offsetTop;aV+=aW.offsetLeft;if(a.offset.doesNotAddBorder&&!(a.offset.doesAddBorderForTableAndCells&&K.test(aW.nodeName))){a0+=parseFloat(aZ.borderTopWidth)||0;
...
aS.innerHTML=aU;aR.insertBefore(aS,aR.firstChild);aV=aS.firstChild;aX=aV.firstChild;
aY=aV.nextSibling.firstChild.firstChild;this.doesNotAddBorder=(aX.offsetTop!==5);
this.doesAddBorderForTableAndCells=(aY.offsetTop===5);aX.style.position="fixed";aX.style.top="20px";
this.supportsFixedPosition=(aX.offsetTop===20||aX.offsetTop===15);aX.style.position=aX.style.top="";
aV.style.overflow="hidden";aV.style.position="relative";this.subtractsBorderForOverflowNotVisible=(aX.offsetTop===-5);
this.doesNotIncludeMarginInBodyOffset=(aR.offsetTop!==aT);aR.removeChild(aS);aR=aS=aV=aX=aW=aY=null;
a.offset.initialize=a.noop},bodyOffset:function(aR){var aT=aR.offsetTop,aS=aR.offsetLeft;
a.offset.initialize();if(a.offset.doesNotIncludeMarginInBodyOffset){aT+=parseFloat(a.css(aR,"marginTop"))||0;
...
if(a2){aZ=aW.position()}aT=a2?aZ.top:parseInt(aR,10)||0;aV=a2?aZ.left:parseInt(a1,10)||0;
if(a.isFunction(a3)){a3=a3.call(aU,aX,aS)}if(a3.top!=null){a0.top=(a3.top-aS.top)+aT
}if(a3.left!=null){a0.left=(a3.left-aS.left)+aV}if("using" in a3){a3.using.call(aU,a0)
...
aU.top-=parseFloat(a.css(aT,"marginTop"))||0;aU.left-=parseFloat(a.css(aT,"marginLeft"))||0;
aR.top+=parseFloat(a.css(aS[0],"borderTopWidth"))||0;aR.left+=parseFloat(a.css(aS[0],"borderLeftWidth"))||0;
return{top:aU.top-aR.top,left:aU.left-aR.left}},offsetParent:function(){return this.map(function(){var aR=this.offsetParent||aa.body;
...
};b.prototype.html=function(e){var c=this.bufferedCommand("flushContent");if(e===undefined){return c.text||c.html||this.$().html()
}c.text=undefined;c.html=e};b.prototype.text=function(e){var c=this.bufferedCommand("flushContent");
if(e===undefined){return c.text||c.html||this.$().text()}c.text=e;c.html=undefined
};b.prototype.flushContent=function(c){if(c.text!==undefined){this.$().text(c.text)
}else{if(c.html!==undefined){this.$().html(c.html)}}};b.prototype.attr=function(f,g){if(typeof f==="object"){for(var c in f){this.attr(c,f[c])
}return}if(f==="class"){if(g===undefined){return this.setClass(g).join(" ")}else{return this.setClass(g)
}}else{if(f==="html"){return this.html(g)}else{if(f==="text"){return this.text(g)
}else{if(f==="style"){return this.resetStyles(g)}}}}var e=this.bufferedCommand("flushAttributes");
if(!e.attr){e.attr={}}e.attr[f]=g};b.prototype.flushAttributes=function(g){var c=g.attr,h=this.$(),e;
for(var f in c){if(!c.hasOwnProperty(f)){continue}e=c[f];if(e!==null){h.attr(f,e)
}else{h.removeAttr(f)}}};b.prototype._STYLE_REGEX=/-?\s*([^:\s]+)\s*:\s*([^;]+)\s*;?/g;
b.prototype._camelizeStyleName=function(c){var e=c.match(/^-(webkit|moz|o)-/),f=c.camelize();
if(e){return f.substr(0,1).toUpperCase()+f.substr(1)}else{return f}};b.prototype._dasherizeStyleName=function(c){var e=c.dasherize();
if(e.match(/^(webkit|moz|ms|o)-/)){e="-"+e}return e};b.prototype._loadStyles=function(c){if(!c){c=this.$().attr("style")
}if(c&&(c=c.toString()).length>0){if(SC.browser.msie){c=c.toLowerCase()}var g={};
var f=this._STYLE_REGEX,e;f.lastIndex=0;while(e=f.exec(c)){g[this._camelizeStyleName(e[1])]=e[2]
}return g}else{return{}}};b.prototype.resetStyles=function(e){var c=this.bufferedCommand("flushStyles");
c._styles=this._loadStyles(e||" ")};b.prototype.styles=function(){var c=this.bufferedCommand("flushStyles");
if(!c._styles){c._styles=this._loadStyles()}return c._styles};b.prototype.css=function(f,g){if(typeof f==="object"){for(var c in f){this.css(c,f[c])
}return}var e=this.bufferedCommand("flushStyles");if(!e._styles){e._styles=this._loadStyles()
}e._styles[f]=g};b.prototype.flushStyles=function(f){var h=f._styles;var j="";var e,i,g=[],c=0;
for(e in h){if(!h.hasOwnProperty(e)){continue}i=h[e];if(i===null){continue}if(typeof i==="number"&&e!=="zIndex"&&e!=="fontWeight"&&e!=="opacity"){i+="px"
}g[c++]=this._dasherizeStyleName(e)+": "+i}this.$().attr("style",g.join("; "))};b.prototype._hashFromClassNames=function(g){if(typeof g==="string"){g=g.split(" ")
}var e,c=g.length,f={};for(e=0;e<c;e++){f[g[e]]=true}return f};b.prototype.setClass=function(h,c){var g=this.bufferedCommand("flushClassNames"),f;
if(h===undefined){if(!g.classNames){g.classNames=this._hashFromClassNames(this._el.className)
}var i=g.classNames,e=[];for(f in i){if(f&&i[f]){e.push(f)}}return e}if(c!==undefined){if(!g.classNames){g.classNames=this._hashFromClassNames(this._el.className)
}g.classNames[h]=c||NO;return}if(typeof h==="string"||jQuery.isArray(h)){g.classNames=this._hashFromClassNames(h);
return}if(typeof h==="object"){if(!g.classNames){g.classNames=this._hashFromClassNames(this._el.className)
}for(f in h){g.classNames[f]=h[f]}}};b.prototype.hasClass=function(e){var c=this.bufferedCommand("flushClassNames");
if(!c.classNames){c.classNames=this._hashFromClassNames(this._el.className)}return !!c.classNames[e]
};b.prototype.addClass=function(g){if(!g){return}var f=this.bufferedCommand("flushClassNames");
if(!f.classNames){f.classNames=this._hashFromClassNames(this._el.className)}if(typeof g==="string"){g=g.split(" ")
}var e,c=g.length;for(e=0;e<c;e++){f.classNames[g[e].trim()]=true}};b.prototype.removeClass=function(e){var c=this.bufferedCommand("flushClassNames");
if(!c.classNames){c.classNames=this._hashFromClassNames(this._el.className)}c.classNames[e]=false
};b.prototype.resetClassNames=function(e){var c=this.bufferedCommand("flushClassNames");
...
}}}a(b);a(b.prototype);return b})();(function(){jQuery.buffer=jQuery.bufferedJQuery=function(c,e){return new jQuery.bufferedJQuery.prototype.init(c,e)
...
var e=jQuery.fn.init.call(this,c,f);e.isBuffered=true;jQuery._isBuffering--;return e
...
break}}}}}return f};jQuery.extend(jQuery.bufferedJQuery.prototype,{html:function(g){if(g===undefined){if(this.length<1){return undefined
}return jQuery.Buffer.bufferForElement(this[f]).html()}var c=this.length,f;for(f=0;
f<c;f++){var e=jQuery.Buffer.bufferForElement(this[f]);e.html(g)}return this},text:function(g){if(g===undefined){if(this.length<1){return undefined
}return jQuery.Buffer.bufferForElement(this[f]).text()}var c=this.length,f;for(f=0;
f<c;f++){var e=jQuery.Buffer.bufferForElement(this[f]);e.text(g)}return this},attr:function(g,h){if(typeof h==="undefined"&&typeof g==="string"){if(this.length<1){return false
}var e=jQuery.Buffer.bufferForElement(this[0]);return e.attr(g)}var c=this.length,f;
for(f=0;f<c;f++){var e=jQuery.Buffer.bufferForElement(this[f]);e.attr(g,h)}return this
},hasClass:function(c){if(this.length<1){return false}return jQuery.Buffer.bufferForElement(this[0]).hasClass(c)
},setClass:function(h,f){var c=this.length,g;for(g=0;g<c;g++){var e=jQuery.Buffer.bufferForElement(this[g]);
...
},resetClassNames:function(){var c=this.length,f;for(f=0;f<c;f++){var e=jQuery.Buffer.bufferForElement(this[f]);
e.resetClassNames()}return this},css:function(g,h){var c=this.length,f;for(f=0;f<c;
f++){var e=jQuery.Buffer.bufferForElement(this[f]);e.css(g,h)}return this},styles:function(){if(this.length<1){return null
...
}var b=[],a=c.length;while(--a>=0){b[a]=c[a]}return b},guidKey:jQuery.expando,_guidPrefixes:{number:"nu",string:"st"},_guidCaches:{number:{},string:{}},_numberGuids:[],_stringGuids:{},_keyCache:{},guidFor:function(f){if(f===undefined){return"(undefined)"
}if(f===null){return"(null)"}var e=typeof f;if(e===SC.T_NUMBER||e===SC.T_STRING){b=this._guidCaches[e];
c=b[f];if(!c){c="st"+(jQuery.uuid++);b[f]=c}return c}else{if(e===SC.T_BOOL){return(f)?"(true)":"(false)"
}}var a=this.guidKey;if(f[a]){return f[a]}if(f===Object){return"(Object)"}if(f===Array){return"(Array)"
}var b,c;var e=typeof f;return SC.generateGuid(f,"sc")},keyFor:function(e,c){var b,a=this._keyCache[e];
if(!a){a=this._keyCache[e]={}}b=a[c];if(!b){b=a[c]=e+"_"+c}return b},generateGuid:function(c,b){var a=(b+(jQuery.uuid++));
if(c){c[this.guidKey]=a}return a},hashFor:function(){var a=arguments.length,c="",g,e,b;
for(b=0;b<a;++b){g=arguments[b];c+=(g&&(e=g.hash)&&(typeof e===SC.T_FUNCTION))?e.call(g):this.guidFor(g)
}return c===""?null:c},isEqual:function(e,c){return this.hashFor(e)===this.hashFor(c)
},compare:function(t,q){if(t===q){return 0}var k=SC.typeOf(t);var h=SC.typeOf(q);
var b=SC.ORDER_DEFINITION_MAPPING;if(!b){var e=SC.ORDER_DEFINITION;b=SC.ORDER_DEFINITION_MAPPING={};
var s,o;for(s=0,o=e.length;s<o;++s){b[e[s]]=s}delete SC.ORDER_DEFINITION}var u=b[k];
var c=b[h];if(u<c){return -1}if(u>c){return 1}switch(k){case SC.T_BOOL:case SC.T_NUMBER:if(t<q){return -1
...
}return b},copy:function(e,b){var c=e,a;if(e){if(e.isCopyable){return e.copy(b)}if(e.clone){return e.clone()
}}switch(jQuery.type(e)){case"array":c=e.slice();if(b){a=c.length;while(a--){c[a]=SC.copy(c[a],true)
}break}case"object":c={};for(var f in e){c[f]=b?SC.copy(e[f],true):e[f]}}return c
...
},observes:function(c,a){var g=a.length,b=null,f=null;while(--g>=0){var e=a[g];if((e.indexOf(".")<0)&&(e.indexOf("*")<0)){if(!b){b=c.localPropertyPaths=[]
}b.push(e)}else{if(!f){f=c.propertyPaths=[]}f.push(e)}}return c}};SC.mixin(Function.prototype,{property:function(){return SC.Function.property(this,arguments)
...
return c.replace(/%@([0-9]+)?/g,function(e,f){f=(f)?parseInt(f,0)-1:a++;e=b[f];return((e===null)?"(null)":(e===undefined)?"":e).toString()
})},loc:function(b,a){var b=SC.STRINGS[b]||b;return SC.String.fmt(b,arguments)},w:function(g){var e=[],f=g.split(" "),b=f.length,c,a=0;
for(a=0;a<b;++a){c=f[a];if(c.length!==0){e.push(c)}}return e}};SC.mixin(String.prototype,{fmt:function(){return SC.CoreString.fmt(this,arguments)
},loc:function(){return SC.CoreString.loc(this,arguments)},w:function(){return SC.CoreString.w(this)
}});if(!Date.now){Date.now=function(){return new Date().getTime()}}SC.ObserverSet={add:function(h,i,f){var g=SC.guidFor(h),c=SC.guidFor(i);
var a=this._members,b=this.members;var e=a[g];if(!e){e=a[g]={}}if(e[c]===undefined){e[c]=b.length
}else{return}b.push([h,i,f])},remove:function(h,i){var f=SC.guidFor(h),b=SC.guidFor(i);
var e=this._members[f],a=this.members;if(!e){return false}var c=e[b];if(c===undefined){return false
}if(c!==a.length-1){var g=(a[c]=a[a.length-1]);this._members[SC.guidFor(g[0])][SC.guidFor(g[1])]=c
}a.pop();delete this._members[f][b];return true},invokeMethods:function(){var b=this.members,e;
for(var c=0,a=b.length;c<a;c++){e=b[c];e[1].call(e[0])}},clone:function(){var c=SC.ObserverSet.create(),e=this.members;
c._members=SC.clone(this._members);var f=c.members;for(var b=0,a=e.length;b<a;b++){f[b]=SC.clone(e[b]);
f[b].length=3}return c},create:function(){return new SC.ObserverSet.constructor()
...
}}else{return b}}},set:function(j,h){var b=this[j],k=this.automaticallyNotifiesObserversFor(j),g=h,e,a,i,f;
if(h===undefined&&SC.typeOf(j)===SC.T_HASH){var c=j;for(j in c){if(!c.hasOwnProperty(j)){continue
}this.set(j,c[j])}return this}if(!k&&this._kvo_cacheable&&(a=this._kvo_cache)){e=this._kvo_cachedep;
if(!e||(e=e[j])===undefined){e=this._kvo_computeCachedDependentsFor(j)}if(e){i=e.length;
while(--i>=0){f=e[i];a[f.cacheKey]=a[f.lastSetValueKey]=undefined}}}if(b&&b.isProperty){a=this._kvo_cache;
if(b.isVolatile||!a||(a[b.lastSetValueKey]!==h)){if(!a){a=this._kvo_cache={}}a[b.lastSetValueKey]=h;
if(k){this.propertyWillChange(j)}g=b.call(this,j,h);if(b.isCacheable){a[b.cacheKey]=g
}if(k){this.propertyDidChange(j,g,YES)}}}else{if(b===undefined){if(k){this.propertyWillChange(j)
}this.unknownProperty(j,h);if(k){this.propertyDidChange(j,g)}}else{if(this[j]!==h){if(k){this.propertyWillChange(j)
}g=this[j]=h;if(k){this.propertyDidChange(j,g)}}}}return this},unknownProperty:function(a,b){if(!(b===undefined)){this[a]=b
...
h.remove(g,i);if(h.getMembers().length===0){this._kvo_for("_kvo_observed_keys",SC.CoreSet).remove(c)
...
if(p){q=SC.clone(p.getMembers());k=q.length;for(g=0;g<k;g++){a=q[g];if(a[3]===s){continue
}if(!a[1]){console.log(a)}u=a[0]||this;c=a[1];b=a[2];a[3]=s;if(h){console.log('%@...firing observer on %@ for key "%@"'.fmt(i,u,v))
...
}c.call(this,this,v,null,s)}}}if(e&&v!=="*"){q=SC.clone(e.getMembers());k=q.length;
for(g=0;g<k;g++){a=q[g];u=a[0]||this;c=a[1];b=a[2];if(h){console.log('%@...firing * observer on %@ for key "%@"'.fmt(i,u,v))
...
},groupBy:function(j){var c=this.get?this.get("length"):this.length,e=[],i=null,a=SC.Enumerator._popContext(),f=[],k=[],g,b,h;
for(g=0;g<c;g++){b=this.nextObject(g,i,a);h=b?(b.get?b.get(j):b[j]):null;if(SC.none(f[h])){f[h]=[];
k.push(h)}f[h].push(b);i=b}i=null;a=SC.Enumerator._pushContext(a);for(g=0,c=k.length;
g<c;g++){e.push(f[k[g]])}return e}};SC._buildReducerFor=function(a,b){return function(e,f){var g=this[a];
...
}}return h},groupBy:function(i){var f=this.length,h=[],k=[],g=[],e,j,l;for(e=0;e<f;
e++){j=this[e];l=j?(j.get?j.get(i):j[i]):null;if(SC.none(k[l])){k[l]=[];g.push(l)
}k[l].push(j)}for(e=0,f=g.length;e<f;e++){h.push(k[g[e]])}return h},find:function(k,j){if(typeof k!=="function"){throw new TypeError()
...
}};var c={forEach:function(j,h){if(typeof j!=="function"){throw new TypeError()}if(h===undefined){h=null
}for(var f=0,e=this.length;f<e;f++){var g=this[f];j.call(h,g,f,this)}return this},map:function(k,j){if(typeof k!=="function"){throw new TypeError()
}if(j===undefined){j=null}var f=[];for(var g=0,e=this.length;g<e;g++){var h=this[g];
f[g]=k.call(j,h,g,this)}return f},filter:function(k,j){if(typeof k!=="function"){throw new TypeError()
}if(j===undefined){j=null}var f=[];for(var g=0,e=this.length;g<e;g++){var h=this[g];
if(k.call(j,h,g,this)){f.push(h)}}return f},every:function(j,i){if(typeof j!=="function"){throw new TypeError()
}var f=this.length;if(i===undefined){i=null}var g=YES;for(var e=0;g&&(e<f);e++){var h=this[e];
if(!j.call(i,h,e,this)){g=NO}}return g},some:function(j,i){if(typeof j!=="function"){throw new TypeError()
}var f=this.length;if(i===undefined){i=null}var g=NO;for(var e=0;(!g)&&(e<f);e++){var h=this[e];
if(j.call(i,h,e,this)){g=YES}}return g},reduce:function(k,g,j){if(typeof k!=="function"){throw new TypeError()
...
b.source=e;b.indexes=g?g.frozenCopy():null;b.target=f;b.method=h;b.context=c;b.isDeep=a||false;
b.beginObserving();return b},extend:function(e){var c=SC.beget(this),b=arguments;
for(var f=0,a=b.length;f<a;f++){SC.mixin(c,b[f])}return c},destroy:function(a){this.endObserving();
...
var a=this._beginObservingForEach,b=this.source;if(!a){a=this._beginObservingForEach=function(e){var f=b.objectAt(e);
if(f&&f.addObserver){c.push(f);f._kvo_needsRangeObserver=true}}}this.indexes.forEach(a);
this.isObserving=false;SC.Observers.addPendingRangeObserver(this);return this},setupPending:function(b){var f=this.observing;
if(this.isObserving||!f||(f.get("length")===0)){return true}if(f.contains(b)){this.isObserving=true;
var c=this._setupPendingForEach;if(!c){var e=this.source,g=this.objectPropertyDidChange,a=this;
c=this._setupPendingForEach=function(h){var k=e.objectAt(h),i=SC.guidFor(k),j;if(k&&k.addObserver){f.push(k);
k.addObserver("*",a,g);j=a[i];if(j==null){a[i]=h}else{if(j.isIndexSet){j.add(h)}else{a[i]=SC.IndexSet.create(j).add(h)
}}}}}this.indexes.forEach(c);return true}else{return false}},endObserving:function(){if(!this.isDeep){return this
}var f=this.observing;if(this.isObserving){var b=this.objectPropertyDidChange,c=this.source,a,g,e;
if(f){g=f.length;for(a=0;a<g;a++){e=f[a];e.removeObserver("*",this,b);this[SC.guidFor(e)]=null
}f.length=0}this.isObserving=false}if(f){f.clear()}return this},rangeDidChange:function(b){var a=this.indexes;
...
if(b&&!b.isIndexSet){b=this[c]=SC.IndexSet.create(b).freeze()}i.call(this.target,this.source,e,g,b,f||a,a)
...
}else{c=(c<0)?Math.ceil(c):Math.floor(c)}if(c<0){c+=a}for(b=c;b<a;b++){if(this.objectAt(b,YES)===e){return b
...
SC.Set=SC.mixin({},SC.Enumerable,SC.Observable,SC.Freezable,{create:function(c){var e,b,f=SC.Set._pool,g=this.isObservable,a;
if(!g&&c===undefined&&f.length>0){return f.pop()}else{e=SC.beget(this);if(g){e.initObservable()
}if(c&&c.isEnumerable&&c.get("length")>0){e.isObservable=NO;if(c.isSCArray){a=c.get("length");
for(b=0;b<a;b++){e.add(c.objectAt(b))}}else{if(c.isSet){a=c.length;for(b=0;b<a;b++){e.add(c[b])
}}else{c.forEach(function(h){e.add(h)},this)}}e.isObservable=g}}return e},isSet:YES,length:0,firstObject:function(){return(this.length>0)?this[0]:undefined
...
}if(SC.none(f)){return this}var c,e=((c=f.hash)&&(typeof c==="function"))?c.call(f):SC.guidFor(f),b=this[e],a=this.length;
if((b>=a)||(this[b]!==f)){this[a]=f;this[e]=a;this.length=a+1;if(this.setObservers){this.didAddItem(f)
...
}}else{if(c.isSet){a=c.length;while(--a>=0){this.add(c[a])}}else{c.forEach(function(e){this.add(e)
},this)}}if(b){this.endPropertyChanges()}return this},remove:function(g){if(this.isFrozen){throw SC.FROZEN_ERROR
}if(g===null||g===undefined){return this}var c,e=(g&&(c=g.hash)&&(typeof c===SC.T_FUNCTION))?c.call(g):SC.guidFor(g),b=this[e],a=this.length,f;
if((b===null||b===undefined)||(b>=a)||(this[b]!==g)){return this}delete this[e];if(b<(a-1)){f=this[b]=this[a-1];
e=(f&&(c=f.hash)&&(typeof c===SC.T_FUNCTION))?c.call(f):SC.guidFor(f);this[e]=b}this.length=a-1;
if(this.isObservable){this.enumerableContentDidChange()}if(this.setObservers){this.didRemoveItem(g)
...
if(!b){b=this.rangeObservers=SC.CoreSet.create()}b.add(a);return this},_TMP_OUT:[],flush:function(b){var h=this.queue;
if(h&&h.length>0){var m=(this.queue=[]);for(var e=0,a=h.length;e<a;e++){var n=h[e];
if(!n){continue}var j=SC.tupleForPropertyPath(n[0],n[3]);if(j){j[0].addObserver(j[1],n[1],n[2])
}else{m.push(n)}}}if(b._kvo_needsRangeObserver){var k=this.rangeObservers,g=k?k.get("length"):0,c=this._TMP_OUT,f;
for(var e=0;e<g;e++){f=k[e];if(f.setupPending(b)){c.push(f)}}if(c.length>0){k.removeEach(c)
...
SC.generateGuid(c,"sc");c.subclasses=SC.Set.create();this.subclasses.add(c);var g=(c.prototype=SC.beget(this.prototype));
...
var e=this.initMixin;a=(e)?e.length:0;for(b=0;b<a;b++){e[b].call(this)}return this
...
var b=[];var c=false;var a=function(f,g,k){k--;if(b.indexOf(g)>=0){return}b.push(g);
for(var h in g){if(h=="__scope__"){continue}if(h=="superclass"){continue}if(h=="__SC__"){h="SC"
}if(!h.match(/^[A-Z0-9]/)){continue}if(h=="SC"){if(c){continue}c=true}var m=(f)?[f,h].join("."):h;
var j=g[h];try{var i=SC.typeOf(j)}catch(l){break}switch(i){case SC.T_CLASS:if(!j._object_className){j._object_className=m
}if(k>=0){a(m,j,k)}break;case SC.T_OBJECT:if(k>=0){a(m,j,k)}break;case SC.T_HASH:if(((f)||(m==="SC"))&&(k>=0)){a(m,j,k)
...
SC._ChainObserver=function(a){this.property=a};SC._ChainObserver.createChain=function(g,m,h,a,b){var e=m.split("."),k=new SC._ChainObserver(e[0]),j=k;
for(var f=1,c=e.length;f<c;f++){j=j.next=new SC._ChainObserver(e[f])}k.objectDidChange(g);
j.target=h;j.method=a;j.context=b;return k};SC._ChainObserver.prototype={isChainObserver:true,object:null,property:null,next:null,target:null,method:null,objectDidChange:function(a){if(a===this.object){return
...
}var b=[];for(var e=0;e<c.length;e++){b[e]=c[e]}return b},_argumentsToString:function(){var b="";
...
}return NO};SC.run=function(g,f,b){var a=SC.RunLoop.isRunLoopInProgress();if(SC.ExceptionHandler&&SC.ExceptionHandler.enabled){try{if(b||!a){SC.RunLoop.begin()
}if(g){g.call(f)}if(b||!a){SC.RunLoop.end()}}catch(c){SC.ExceptionHandler.handleException(c);
if(!SC.browser.msie){throw c}}}else{if(b||!a){SC.RunLoop.begin()}if(g){g.call(f)}if(b||!a){SC.RunLoop.end()
...
},updatePropertyFromContent:function(g,c,f,e){var a,b;if(f===undefined){f="content"+g.capitalize()+"Key"
}if(this[f]){f=this.get(f)}else{if((a=this.displayDelegate)&&(b=a[f])){f=a.get?a.get(f):b
}else{return this}}if(c==="*"||c===f){if(e===undefined){e=this.get("content")}if(e){b=e.get?e.get(f):e[f]
}else{b=null}this.set(g,b)}return this},updateContentWithValueObserver:function(){var a=this.contentValueKey?this.get("contentValueKey"):this.getDelegateProperty("contentValueKey",this.displayDelegate),b=this.get("content");
...
var g=this.get("controlSize");if(h){b.setClass(f);if(g!==SC.AUTO_CONTROL_SIZE){b.addClass(g)
}}else{b.$().setClass(f);if(g!==SC.AUTO_CONTROL_SIZE){b.$().addClass(g)}}if(!h&&this.$input){var a=this.$input();
...
}.observes("contentValueKey")};SC.DelegateSupport={delegateFor:function(c){var b=1,a=arguments.length,e;
...
this.wheelDeltaY=0-(a.wheelDeltaY||0);this.wheelDeltaX=0-(a.wheelDeltaX||0);if(!SC.browser.chrome){if(f>=533.17&&f<=533.19){b=0.004
...
};SC.mixin(SC.Event,{create:function(a){return new SC.Event(a)},add:function(g,f,h,i,e,a){if(g&&g.isCoreQuery){if(g.length>0){g.forEach(function(j){this.add(j,f,h,i,e)
},this);return this}else{g=g[0]}}if(!g){return this}if(!a){var a=NO}if(g.nodeType===3||g.nodeType===8){return SC.Event
}if(SC.browser.msie&&g.setInterval){g=window}if(SC.typeOf(h)===SC.T_FUNCTION){e=i;
i=h;h=null}else{if(h&&SC.typeOf(i)===SC.T_STRING){i=h[i]}}var c=SC.data(g,"events")||SC.data(g,"events",{}),b=c[f];
if(!b){b=c[f]={};this._addEventListener(g,f,a)}b[SC.hashFor(h,i)]=[h,i,e];SC.Event._global[f]=YES;
g=c=b=null;return this},remove:function(g,f,h,i){if(g&&g.isCoreQuery){if(g.length>0){g.forEach(function(j){this.remove(j,f,h,i)
...
while(b&&b!=c){try{b=b.parentNode}catch(a){b=c}}return b===c},_addEventListener:function(f,e,a){var g,c=this.special[e];
if(!a){var a=NO}if(!c||c.setup.call(f)===NO){var b=SC.guidFor(f);this._elements[b]=f;
g=SC.data(f,"listener")||SC.data(f,"listener",function(){return SC.Event.handle.apply(SC.Event._elements[b],arguments)
});if(f.addEventListener){f.addEventListener(e,g,a)}else{if(f.attachEvent){f.attachEvent("on"+e,g)
}}}f=c=g=null},_removeEventListener:function(c,b){var e,a=SC.Event.special[b];if(!a||(a.teardown.call(c)===NO)){e=SC.data(c,"listener");
...
}var a,c,e;for(a in b){if(a==="classNames"){continue}if(!b.hasOwnProperty(a)){continue
}c=b[a];if(c instanceof Function&&!c.base&&(c!==(e=this[a]))){c.base=e}this[a]=c}},create:function(){var c=SC.beget(this);
...
var f=arguments,b=f.length,a,e;for(a=0;a<b;a++){c._extend_self(f[a])}if(c.name){c.classNames.add(c.name)
...
},addRenderer:function(a){this[a.name]=a},renderer:function(b){var e=this._specializedRenderers[b],c=this[b];
if(!e||e._specializedFrom!==c){if(!c){return null}e=c.extend({classNames:this.classNames,theme:this})
}var a=SC.$A(arguments);a.shift();e=e.create.apply(e,a);return e}};SC.BaseTheme=SC.Theme.create({name:""});
...
if(b!==undefined){return b}var e=this.get("theme");if(!e){return undefined}return e[a]
...
this.updateLayer();this.endPropertyChanges()}}return this},updateLayer:function(g){var c,b,a,e;
var f=g||this.renderContext(this.get("layer"));this._renderLayerSettings(f,NO);e=!this.update;
if(e){this.render(f,NO)}else{this.update(f.$())}if(c=this.renderMixin){a=c.length;
for(b=0;b<a;++b){c[b].call(this,f,NO)}}f.update();if(f._innerHTMLReplaced){var h=this.get("pane");
if(h&&h.get("isPaneAttached")){this._notifyDidAppendToDocument()}}if(this.useStaticLayout){this.viewDidResize()
...
}this.set("layer",null)},renderToContext:function(f,g){var e,c,b,a;this.beginPropertyChanges();
this.set("layerNeedsUpdate",NO);if(SC.none(g)){g=YES}this._renderLayerSettings(f,g);
e=!this.update;if(e){this.render(f,g)}else{if(g){this.render(f)}else{this.update(f.$())
}}if(c=this.renderMixin){a=c.length;for(b=0;b<a;++b){c[b].call(this,f,g)}}this.endPropertyChanges()
},_renderLayerSettings:function(f,i){f.resetClassNames();f.resetStyles();var g=this.get("theme");
var c=g.classNames,b,a=c.length;for(b=0;b<a;b++){f.addClass(c[b])}var e=this.get("renderDelegate");
if(e&&e.name){f.addClass(e.name)}f.addClass(this.get("classNames"));var h=this.get("cursor");
if(h){f.addClass(h.get("className"))}if(this.get("isTextSelectable")){f.addClass("allow-select")
...
}f.id(this.get("layerId"));f.attr("role",this.get("ariaRole"));if(!this.get("isEnabled")){f.attr("aria-disabled","true")
}if(this.get("backgroundColor")){f.css("backgroundColor",this.get("backgroundColor"))
}this.renderLayout(f,i)},prepareContext:function(a,b){if(SC.none(b)){b=YES}if(b){this.renderToContext(a)
}else{this.updateLayer(a)}},renderDelegateProxy:function(){return SC.View._RenderDelegateProxy.createForView(this)
}.property("renderDelegate").cacheable(),renderChildViews:function(f,g){var e=this.get("childViews"),b=e.length,a,c;
for(a=0;a<b;++a){c=e[a];if(!c){continue}f=f.begin(c.get("tagName"));c.renderToContext(f,g);
f=f.end()}return f},renderDelegate:function(c,e){if(e){this._setRenderDelegate=e}if(this._setRenderDelegate){return this._setRenderDelegate
...
b<a;b++){e=c[b];if(e._notifyDidAppendToDocument){e._notifyDidAppendToDocument()}}}.observes("childViews"),tagName:"div",ariaRole:null,classNames:["sc-view"],toolTip:null,displayToolTip:function(){var a=this.get("toolTip");
...
}if(b){return b}}b=null}return b},init:function(){var i=this.get("parentView"),b=this.get("theme"),j,g,h,e,c,a;
...
h=a.length;while(--h>=0){this.addObserver(a[h],this,this.displayDidChange)}if(this.get("isDropTarget")){SC.Drag.addDropTarget(this)
...
}b[a]=e}}}}if(c){this.set("layout",b)}return this},animate:function(o,k,e,n){var g,p;
if(typeof o===SC.T_STRING){g={};g[o]=k;p=e}else{g=o;p=k;n=e}var c=SC.typeOf(p);if(c===SC.T_NUMBER){p={duration:p}
}else{if(c!==SC.T_HASH){throw"Must provide options hash or duration!"}}if(n){p.callback=n
}var a=p.timing;if(a){if(typeof a!==SC.T_STRING){p.timing="cubic-bezier("+a[0]+", "+a[1]+", "+a[2]+", "+a[3]+")"
}}else{p.timing="linear"}var h=SC.clone(this.get("layout")),i=NO,j,m,b,f,l;if(!h.animate){h.animate={}
}for(l in g){if(!g.hasOwnProperty(l)){continue}j=g[l];m=h[l];if(m!==j){i=YES}if(SC.ANIMATABLE_PROPERTIES[l]){f=h.animate[l];
if(j==null){throw"Can only animate to an actual value!"}if(f&&f.duration!==p.duration){i=YES
}h.animate[l]=p}h[l]=j}if(i){this.set("layout",h)}return this},resetAnimation:function(){var c=this.get("layout"),f=c.animate,e=NO,b;
if(!f){return}var a;for(b in f){e=YES;delete f[b]}if(e){this.set("layout",c);this.notifyPropertyChange("layout")
}return this},transitionDidEnd:function(a){this.get("layoutStyleCalculator").transitionDidEnd(a)
},layout:{top:0,left:0,bottom:0,right:0},convertFrameToView:function(j,e){var c=0,b=0,h=0,g=0,a=this,i;
...
}if(s.width===o){s.width=w?w.clientWidth:0}}if(this.get("hasBorder")){m=this.get("borderTop")||0;
b=this.get("borderLeft")||0;s.height-=m+(this.get("borderBottom")||0);s.y+=m;s.width-=b+(this.get("borderRight")||0);
...
}return this},wantsAcceleratedLayer:NO,hasAcceleratedLayer:function(){if(this.get("wantsAcceleratedLayer")&&SC.platform.supportsAcceleratedLayers){var c=this.get("layout"),e=c.animate,b=SC.LAYOUT_AUTO,a;
if(e&&(e.top||e.left)){for(a in e){if(SC.CSS_TRANSFORM_MAP[a]&&((e.top&&e.top.duration!==e[a].duration)||(e.left&&e.left.duration!==e[a].duration))){return NO
...
}.property("parentView").cacheable(),layoutDidChange:function(){var h=this._previousLayout,g=this.get("layout"),j=YES,e,c,a,b;
if(!SC.none(g.rotate)){if(SC.none(g.rotateX)){g.rotateX=g.rotate;console.warn("Please set rotateX instead of rotate")
}}if(!SC.none(g.rotateX)){g.rotate=g.rotateX}else{delete g.rotate}var i=g.animations;
if(i){if(!SC.none(i.rotate)){if(SC.none(i.rotateX)){i.rotateX=i.rotate;console.warn("Please animate rotateX instead of rotate")
}}if(!SC.none(i.rotateX)){i.rotate=i.rotateX}else{delete i.rotate}}if(h&&h!==g){e=h.width;
if(e!==undefined){a=g.width;if(e===a){c=h.height;if(h!==undefined){b=g.height;if(c===b){j=NO
}}}}}this.beginPropertyChanges();this.notifyPropertyChange("hasAcceleratedLayer");
this.notifyPropertyChange("layoutStyle");if(j){this.viewDidResize()}else{this._viewFrameDidChange()
}this.endPropertyChanges();var f=this.get("layoutView");if(f){f.set("childViewsNeedLayout",YES);
f.layoutDidChangeFor(this);if(f.get("childViewsNeedLayout")){f.invokeOnce(f.layoutChildViewsIfNeeded)
}}this._previousLayout=g;return this},childViewsNeedLayout:NO,layoutDidChangeFor:function(b){var a=this._needLayoutViews;
...
return this},convertLayoutToAnchoredLayout:function(g,n){var i={top:0,left:0,width:n.width,height:n.height},e=n.width,l=n.height,m=g.right,a=g.left,k=g.top,h=g.bottom,j=g.width,f=g.height,c=g.centerX,b=g.centerY;
...
}return a},loc:function(f){var b=f.childViews;delete f.childViews;this.applyLocalizedAttributes(f);
if(SC.ViewDesigner){SC.ViewDesigner.didLoadLocalization(this,SC.$A(arguments))}var e=this.prototype.childViews,a=e.length,c;
while(--a>=0){c=e[a];f=b[a];if(f&&c&&c.loc){c.loc(f)}}return this},applyLocalizedAttributes:function(a){SC.mixin(this.prototype,a)
...
}}}}};SC.View._RenderDelegateProxy={isViewRenderDelegateProxy:YES,createForView:function(c){var e=SC.beget(this);
var g=c.get("displayProperties"),f={};for(var b=0,a=g.length;b<a;b++){f[g[b]]=YES
}f.theme=YES;e._displayPropertiesLookup=f;e.renderState={};e.view=c;return e},get:function(b){if(this[b]!==undefined){return this[b]
...
},didChangeFor:function(e){var b=arguments.length,a;for(a=1;a<b;a++){var f=arguments[a],c="display"+f.capitalize();
if(this._displayPropertiesLookup[c]){if(this.view.didChangeFor(e,c)){return YES}}else{if(this._displayPropertiesLookup[f]){if(this.view.didChangeFor(e,f)){return YES
}}}}return NO}};SC.View.LayoutStyleCalculator=SC.Object.extend({_layoutDidUpdate:function(){var g=this.get("layout");
if(!g){return}this.dims=SC._VIEW_DEFAULT_DIMS;this.loc=this.dims.length;var k=(this.right=g.right);
this.hasRight=(k!=null);var c=(this.left=g.left);this.hasLeft=(c!=null);var h=(this.top=g.top);
this.hasTop=(h!=null);var a=(this.bottom=g.bottom);this.hasBottom=(a!=null);var b=(this.width=g.width);
this.hasWidth=(b!=null);var l=(this.height=g.height);this.hasHeight=(l!=null);this.minWidth=((g.minWidth===undefined)?null:g.minWidth);
var j=(this.maxWidth=(g.maxWidth===undefined)?null:g.maxWidth);this.hasMaxWidth=(j!=null);
this.minHeight=(g.minHeight===undefined)?null:g.minHeight;var i=(this.maxHeight=(g.maxHeight===undefined)?null:g.maxHeight);
this.hasMaxHeight=(i!=null);var f=(this.centerX=g.centerX);this.hasCenterX=(f!=null);
var e=(this.centerY=g.centerY);this.hasCenterY=(e!=null);this.zIndex=(g.zIndex!=null)?g.zIndex.toString():null;
this.opacity=(g.opacity!=null)?g.opacity.toString():null;this.backgroundPosition=(g.backgroundPosition!=null)?g.backgroundPosition:null;
...
}if(this.height===SC.LAYOUT_AUTO){this._invalidAutoValue("height")}}if(SC.platform.supportsCSSTransforms){var e=c.animate,a,b;
if(e){for(b in e){if(SC.CSS_TRANSFORM_MAP[b]){if(this._pendingAnimations&&this._pendingAnimations["-"+SC.platform.cssPrefix+"-transform"]){throw"Animations of transforms must be executed simultaneously!"
}if(a&&e[b].duration!==a){console.warn("Can't animate transforms with different durations! Using first duration specified.");
e[b].duration=a}a=e[b].duration}}}}},_calculatePosition:function(k){var c=null,e=this.get("turbo"),h=this.layout,j=this.ret;
var a,l,o,n,f,b,m,i,g;if(k==="x"){a="left";l="right";o="width";n="maxWidth";f="marginLeft";
b=this.hasLeft;m=this.hasRight;i=this.hasWidth;g=this.hasMaxWidth}else{a="top";l="bottom";
o="height";n="maxHeight";f="marginTop";b=this.hasTop;m=this.hasBottom;i=this.hasHeight;
g=this.hasMaxHeight}j[o]=this._cssNumber(h[o]);j[a]=this._cssNumber(h[a]);j[l]=this._cssNumber(h[l]);
if(b){if(e){c=j[a];j[a]=0}if(m&&i){j[l]=null}}else{if(!m||(m&&!i&&!g)){j[a]=0}}if(!i&&!m){j[l]=0
}return c},_calculateCenter:function(l){var g=this.layout,i=this.ret,o,a,c,m,f;if(l==="x"){o="width";
a="centerX";c="left";m="right";f="marginLeft"}else{o="height";a="centerY";c="top";
m="bottom";f="marginTop"}i[c]="50%";i[o]=this._cssNumber(g[o])||0;var k=g[o],j=g[a],b=g[c];
var h=SC.isPercentage(k),e=SC.isPercentage(j,YES);if((h&&e)||(!h&&!e)){var n=j-k/2;
i[f]=(h)?Math.floor(n*100)+"%":Math.floor(n)}else{console.warn("You have to set "+o+" and "+a+" using both percentages or pixels");
i[f]="50%"}i[m]=null},_calculateTransforms:function(f,i){if(SC.platform.supportsCSSTransforms){var h=this.get("layout");
var b=SC.platform.domCSSPrefix+"Transform";var e=[];if(this.turbo){e.push("translateX("+(f||0)+"px)","translateY("+(i||0)+"px)");
if(SC.platform.supportsCSS3DTransforms){e.push("translateZ(0px)")}}var g=SC.CSS_TRANSFORM_MAP;
for(var a in g){var c=h[a];if(c!=null){e.push(g[a](c))}}this.ret[b]=e.length>0?e.join(" "):null
}},_calculateAnimations:function(f,c){var e=this.layout,i=e.animate,h;if(!i){return
}if(this.getPath("view.isAnimatable")){return}var g=[],b;this._animatedTransforms=[];
if(!this._pendingAnimations){this._pendingAnimations={}}var j="-"+SC.platform.cssPrefix+"-transform";
if(SC.platform.supportsCSSTransitions){for(h in i){b=i[h];var k=SC.CSS_TRANSFORM_MAP[h];
var a=(h==="top"&&c)||(h==="left"&&f);if(SC.platform.supportsCSSTransforms&&(a||k)){this._animatedTransforms.push(h);
h=j}b.css=h+" "+b.duration+"s "+b.timing;if(!this._pendingAnimations[h]){this._pendingAnimations[h]=b;
g.push(b.css)}}this.ret[SC.platform.domCSSPrefix+"Transition"]=g.join(", ")}else{for(h in i){this._pendingAnimations[h]=i[h]
}}delete e.animate},_cssNumber:function(a){if(a==null){return null}else{if(a===SC.LAYOUT_AUTO){return SC.LAYOUT_AUTO
}else{if(SC.isPercentage(a)){return(a*100)+"%"}else{return Math.floor(a)}}}},calculate:function(){var e=this.get("layout"),b=null,c=null,f=null,a=this.get("turbo"),h=this.ret,k=this.dims,g=this.loc,i=this.get("view"),l,j;
this._handleMistakes(e);if(this.hasLeft||this.hasRight||!this.hasCenterX){f=this._calculatePosition("x")
}else{this._calculateCenter("x")}if(this.hasTop||this.hasBottom||!this.hasCenterY){c=this._calculatePosition("y")
}else{this._calculateCenter("y")}h.minWidth=this.minWidth;h.maxWidth=this.maxWidth;
h.minHeight=this.minHeight;h.maxHeight=this.maxHeight;h.zIndex=this.zIndex;h.opacity=this.opacity;
h.mozOpacity=this.opacity;h.backgroundPosition=this.backgroundPosition;this._calculateTransforms(f,c);
this._calculateAnimations(f,c);for(l in h){j=h[l];if(typeof j===SC.T_NUMBER){h[l]=(j+"px")
}}return h},willRenderAnimations:function(){if(SC.platform.supportsCSSTransitions){var g=this.get("view"),f=g.get("layer"),a=f?f.style:null,c=g.get("layoutStyle"),b=c[SC.platform.domCSSPrefix+"Transition"],e=g.get("layout"),i,j,h;
if(this._activeAnimations){for(i in this._activeAnimations){if(c[i]!==(a?a[i]:null)||!this._pendingAnimations||!this._pendingAnimations[i]||this._activeAnimations[i].duration!==this._pendingAnimations[i].duration){j=this._activeAnimations[i].callback;
if(j){if(this._animatedTransforms&&this._animatedTransforms.length>0){for(h=0;h<this._animatedTransforms.length;
h++){this.runAnimationCallback(j,null,this._animatedTransforms[h],YES)}this._animatedTransforms=null
}else{this.runAnimationCallback(j,null,i,YES)}}this.removeAnimationFromLayout(i,YES)
...
}},runAnimationCallback:function(f,b,c,e){var a=this.get("view");if(f){if(SC.typeOf(f)!==SC.T_HASH){f={action:f}
}f.source=a;if(!f.target){f.target=this}}SC.View.runCallback(f,{event:b,propertyName:c,view:a,isCancelled:e})
},transitionDidEnd:function(b){var c=b.originalEvent.propertyName,e=this.getPath("view.layout"),f,a;
...
a++){this.invokeLater("runAnimationCallback",1,f.callback,b,this._animatedTransforms[a],NO)
}}else{this.invokeLater("runAnimationCallback",1,f.callback,b,c,NO)}SC.RunLoop.end()
}this.removeAnimationFromLayout(c,YES)}},removeAnimationFromLayout:function(c,i,b){if(i){var f=this.getPath("view.layer"),h=[],e;
...
}}var g=this.getPath("view.layout"),a;if(c==="-"+SC.platform.cssPrefix+"-transform"&&this._animatedTransforms&&this._animatedTransforms.length>0){for(a=0;
...
sc_require("mixins/responder_context");SC.Pane=SC.View.extend(SC.ResponderContext,{isPane:YES,page:null,rootResponder:null,currentWindowSize:null,computeParentDimensions:function(h){if(this.get("designer")&&SC.suppressMain){return arguments.callee.base.apply(this,arguments)
...
}this.events[a]=b},start:function(b,a,f,e){if(!this.enabled){return}var g=(f||Date.now()),c;
if(a){c=this._subStatFor(b,a)}else{c=this._statFor(b)}if(e&&c._starts.length>0){c._starts.push("ignore")
...
}else{b.push(this._timelineGenReport(e[c]))}}return b.join("\n")},getTimelineChartContent:function(){var m=this._compileChartData(false);
var h=m.length;if(h===0){return}var c=this.globalStartTime?this.globalStartTime:m[0][1];
var e=m[h-1][2]-c;var o=25+h*30;var s=Math.ceil(e/200)+1;var u=s*50;var n=10,v=300;
var p="<div class = 'sc-benchmark-timeline-chart' style = 'position:relative;'>";
p+="<div class = 'sc-benchmark-top'></div>";for(var q=0;q<s;q++){p+="<div class = 'sc-benchmark-tick' style = '";
p+="left: "+(n+q*50)+"px; ";p+="height: "+o+"px;";p+="'></div>";p+="<div class = 'sc-benchmark-tick-label' style = '";
p+="left: "+(n+q*50)+"px; ";p+="'>"+(q*200)+"ms</div>"}for(q=0;q<h;q++){p+="<div class = 'sc-benchmark-row ";
p+=(q%2===0)?"even":"odd";p+="' style = '";p+="top: "+(50+(q*30))+"px; ";p+="'></div>";
var k=document.createElement("div");var g=m[q][1];var f=m[q][2];var a=m[q][3];p+="<div class = 'sc-benchmark-bar' style = '";
p+="left:"+(n+((g-c)/4))+"px; width: "+((a/4))+"px;";p+="top: "+(28+(q*30))+"px;";
p+="' title = 'start: "+(g-c)+" ms, end: "+(f-c)+" ms, duration: "+a+" ms'";p+=">";
p+="&nbsp;"+m[q][0]+" <span class='sc-benchmark-emphasis'>";p+=a+"ms (start: "+(g-c)+"ms)";
p+="</span>";p+="</div>"}var b=this.events,l=0;for(q in b){var j=b[q]-c;p+="<div class = 'sc-benchmark-event idx"+(l%10)+"' style = '";
p+="left: "+(n+j/4)+"px; height: "+o+"px; top: 20px;";p+="' title = '"+q+": "+j+"'></div>";
l++}p+="</div>";return{html:p,totalCapturedTime:e,pointsCaptured:h,width:u+n+v,height:o}
...
var b=this.getTimelineChartView();var f=b.chartContent.pointsCaptured,e=b.chartContent.totalCapturedTime;
...
}return NO},log:function(e){var c=this.report(e).split("\n"),b=c.length,a;for(a=0;
...
}},loadPreloadEvents:function(){var g=SC.benchmarkPreloadEvents,f=[],b,a,c;if(typeof webkitPerformnce!=="undefined"){SC.mixin(g,webkitPerformane.timing)
}if(!this.globalStartTime){var e="navigation navigationStart headStart".w();a=e.length;
for(b=0;b<a;b++){if(g[e[b]]){this.globalStartTime=g[e[b]];break}}}this.javascriptStartTime=g.headStart;
SC.mixin(this.events,g);this._hasLoadedPreloadEvents=true},_loadBenchmarksFromEvents:function(){if(!this._hasLoadedPreloadEvents){this.loadPreloadEvents()
...
delete b[c+"Start"];delete b[c+"End"]}},_compileChartData:function(h){this._loadBenchmarksFromEvents();
var m=[],a;for(var n in this.stats){var f=this.stats[n];for(var g=0;g<f._times.length;
g++){var o=f._times[g];a=(f._times.length>1)?(g+1)+" - "+n:n;m.push([a,o.start,o.end,o.dur,false]);
if(h){var b=o._subStats;for(var c in b){var l=b[c];for(var e=0;e<l._times.length;
e++){var p=l._times[e];a=(l._times.length>1)?(e+1)+" - "+c:c;m.push([a,p.start,p.end,p.dur,true])
}}}}}m.sort(function(j,i){if(j[1]<i[1]){return -1}else{if(j[1]==i[1]){if(j[3]&&!i[3]){return -1
}if(!j[3]&&i[3]){return 1}return 0}}return 1});return m},_genReport:function(a){var b=this._statFor(a);
var e=(b.runs>0)?(Math.floor(b.amt*1000/b.runs)/1000):0;var c=b._times[b._times.length-1];
return"BENCH %@ msec: %@ (%@x); latest: %@".fmt(e,(b.name||a),b.runs,c.end-c.start)
...
}}SC.Benchmark.addEvent("ready");SC.Benchmark.start("main");SC.run(function(){var h,g,f,e;
do{g=SC._readyQueue;SC._readyQueue=[];for(f=0,e=g.length;f<e;f++){h=g[f];var i=h[0]||document;
var j=h[1];if(j){j.call(i)}}}while(SC._readyQueue.length>0);SC.isReady=YES;SC._readyQueue=null;
...
}b=(f)?f.sendEvent(c,a,e):null},this);return b},listenFor:function(e,c,b,a){b=b?b:this;
e.forEach(function(f){var g=b[f];if(g){SC.Event.add(c,f,b,g,null,a)}},this);c=null;
...
}},averagedTouchesForView:function(j,h){var n=this.touchesForView(j),b=j._scrr_averagedTouches||(j._scrr_averagedTouches={});
if((!n||n.length===0)&&!h){b.x=0;b.y=0;b.d=0;b.touchCount=0}else{var f=this._averagedTouches_touches||(this._averagedTouches_touches=[]);
f.length=0;if(n){var e,g=n.length;for(e=0;e<g;e++){f.push(n[e])}}if(h){f.push(h)}var k,c,a=0,p=0,o,m,l=0;
g=f.length;for(k=0;k<g;k++){c=f[k];a+=c.pageX;p+=c.pageY}a/=g;p/=g;for(k=0;k<g;k++){c=f[k];
o=Math.abs(c.pageX-a);m=Math.abs(c.pageY-p);l+=Math.pow(o*o+m*m,0.5)}l/=g;b.x=a;b.y=p;
b.d=l;b.touchCount=g}return b},assignTouch:function(b,a){if(b.hasEnded){throw"Attemt to assign a touch that is already finished."
...
this._queuedTouchResponder=null;this.makeTouchResponder.apply(this,a)}},makeTouchResponder:function(g,f,c,l){if(this._isMakingTouchResponder){this._queuedTouchResponder=[g,f,c,l];
return}this._isMakingTouchResponder=YES;var i=g.touchResponders,b;if(g.touchResponder===f){this._isMakingTouchResponder=NO;
this._flushQueuedTouchResponder();return}var a;if(f){a=f.get("pane")}else{a=this.get("keyPane")||this.get("mainPane")
...
}}this._isMakingTouchResponder=NO;this._flushQueuedTouchResponder()},captureTouch:function(i,f,h){if(!f){f=this
}var g=i.targetView,c=g,e=[],b,a;if(SC.LOG_TOUCH_EVENTS){SC.Logger.info("  -- Received one touch on %@".fmt(g.toString()))
...
}o.pageX=b.pageX;o.pageY=b.pageY;o.clientX=b.clientX;o.clientY=b.clientY;o.screenX=b.screenX;
o.screenY=b.screenY;o.timeStamp=a.timeStamp;o.event=a;if(o.touchResponder){l=o.touchResponder;
...
n=j.firstObject();a.pageX=n.pageX;a.pageY=n.pageY;a.clientX=n.clientX;a.clientY=n.clientY;
a.screenX=n.screenX;a.screenY=n.screenY;a.touchContext=this;l.tryToPerform("touchesDragged",a,j)
...
}o.timeStamp=a.timeStamp;o.pageX=h.pageX;o.pageY=h.pageY;o.clientX=h.clientX;o.clientY=h.clientY;
o.screenX=h.screenX;o.screenY=h.screenY;o.type="touchend";o.event=a;if(SC.LOG_TOUCH_EVENTS){SC.Logger.info("-- Received touch end")
}if(o.hidesTouchIntercept){o.unhideTouchIntercept();b=YES}if(this._drag){this._drag.tryToPerform("mouseUp",h);
this._drag=null}this.endTouch(o,g,a);this.finishTouch(o)}},this);if(b){return YES
...
}var g=this.get("menuPane"),a=this.get("keyPane"),f=this.get("mainPane");if(g){e=g.performKeyEquivalent(c,b);
if(e){return e}}if(a){e=a.performKeyEquivalent(c,b);if(e||a.get("isModal")){return e
}}if(!e&&f&&(f!==a)){e=f.performKeyEquivalent(c,b);if(e||f.get("isModal")){return e
}}return e},_lastModifiers:null,_handleModifierChanges:function(b){var a;a=this._lastModifiers=(this._lastModifiers||{alt:false,ctrl:false,shift:false});
...
this.clientX=e.clientX;this.clientY=e.clientY;this.screenX=e.screenX;this.screenY=e.screenY
...
SC.platform.domCSSPrefix="Moz"}}}}})();(function(){var f=document.createElement("div");
var g=["-moz-","-moz-","-o-","-ms-","-webkit-"];var a=["moz","Moz","o","ms","webkit"];
var c="",b=null;for(b=0;b<g.length;b++){c+=g[b]+"transition:all 1s linear;";c+=g[b]+"transform: translate(1px, 1px);";
c+=g[b]+"perspective: 500px;"}f.style.cssText=c;for(b=0;b<a.length;b++){if(f.style[a[b]+"TransitionProperty"]!==undefined){SC.platform.supportsCSSTransitions=YES
}if(f.style[a[b]+"Transform"]!==undefined){SC.platform.supportsCSSTransforms=YES}if(f.style[a[b]+"Perspective"]!==undefined||f.style[a[b]+"PerspectiveProperty"]!==undefined){SC.platform.understandsCSS3DTransforms=YES;
...
}}}}catch(h){SC.platform.supportsCSS3DTransforms=NO}if(SC.platform.supportsCSSTransforms&&SC.platform.cssPrefix==="webkit"){SC.platform.supportsAcceleratedLayers=YES
...
b=null}},update:function(){var a=this._elem,e=this.updateMode,g,k,i,f,l,b,j,c,h;this._innerHTMLReplaced=NO;
if(!a){return}g=this.$();if(this.length>0){this._innerHTMLReplaced=YES;if(e===SC.MODE_REPLACE){g.html(this.join())
}else{b=a.cloneNode(false);b.innerHTML=this.join();h=(e===SC.MODE_APPEND)?null:a.firstChild;
j=b.firstChild;while(j){c=j.nextSibling;a.insertBefore(j,c);j=c}j=c=b=h=null}}if(this._idDidChange&&(i=this._id)){g.attr("id",i)
}jQuery.Buffer.flush();a=this._elem=null;return this.prevObject||this},_DEFAULT_ATTRS:{},_TAG_ARRAY:[],_JOIN_ARRAY:[],_STYLE_PAIR_ARRAY:[],end:function(){var n=this._TAG_ARRAY,b,l,j,h,k=this._attrs,e=this._classNames,a=this._id,m=this._styles;
...
},addClass:function(g){if(g===undefined||g===null){console.warn("You are adding an undefined or empty class"+this.toString());
return this}if(this._elem){if(SC.typeOf(g)===SC.T_STRING){this.$().addClass(g)}else{var c,b=g.length;
for(c=0;c<b;c++){this.$().addClass(g[c])}}return this}var h=this.classNames();if(SC.typeOf(g)===SC.T_STRING){if(h.indexOf(g)<0){h.push(g);
this._classNamesDidChange=YES}}else{for(var f=0,a=g.length;f<a;f++){var e=g[f];if(h.indexOf(e)<0){h.push(e);
...
return this}this._classNames=[];this._classNamesDidChange=YES;return this},setClass:function(e,c){if(this._elem){this.$().setClass(e,c);
return this}var g,a,b,f;if(c!==undefined){return c?this.addClass(e):this.removeClass(e)
}else{g=this._classNames;if(!g){g=this._classNames=[]}if(this._cloneClassNames){g=this._classNames=g.slice();
...
}}return this},_STYLE_REGEX:/-?\s*([^:\s]+)\s*:\s*([^;]+)\s*;?/g,styles:function(e,f){if(this._elem){if(e){this.$().resetStyles().css(e)
}return this.$().styles()}var a,c,b;if(e===undefined){if(!this._styles&&this._elem){a=this.$().attr("style");
...
for(a=0;a<f.length;a++){if(c[f[a]]){delete c[f[a]];e=YES}}}return e},resetStyles:function(){this.styles({});
return this},addStyle:function(a,f){if(this._elem){this.$().css(a,f);return this}var b,e=NO,c=this.styles();
...
}},attr:function(a,f){if(this._elem){this.$().attr(a,f);return this}var c,b=this._attrs,e=NO;
...
if(b[c]!==f){b[c]=f;e=YES}}if(e){this._attrsDidChange=YES}}return this},$:function(c){var a,b=this._elem;
...
this._TMP_RANGE={}},objectAt:function(a,e){var c=this._sa_content,b;if(!c){c=this._sa_content=[]
}if((b=c[a])===undefined){if(!e){this.requestIndex(a)}b=c[a]}return b},definedIndexes:function(e){var c=SC.IndexSet.create(),f=this._sa_content,b,a;
...
if(this.wasRangeRequested(f)===-1){e.start=f;e.length=a;this.requestedRangeIndex.push(f);
c.sparseArrayDidRequestRange(this,e)}}else{if(c.sparseArrayDidRequestIndex){while(--a>=0){c.sparseArrayDidRequestIndex(this,f+a)
...
if(!c){c=this._sa_content=[]}var e=b.start,a=b.length;while(--a>=0){c[e+a]=f.objectAt(a)
}if(this._requestingIndex<=0){this.enumerableContentDidChange(b.start,b.length)}return this
},provideObjectAtIndex:function(c,b){var e=this._TMP_PROVIDE_ARRAY,a=this._TMP_PROVIDE_RANGE;
...
while(--c>=e){b[c]=undefined}}}this.enumerableContentDidChange(a.start,a.length);
...
}return this},resetDefault:function(j){var a,f,b,k,i,h;a=this._normalizeKeyName(j);
f=this._userKeyName(a);this.propertyWillChange(j);this.propertyWillChange(a);b=this._written;
if(b){delete b[f]}if(SC.browser.msie=="7.0"){k=document.body}else{if(this.HTML5DB_noLocalStorage){h=this._safari3DB
}else{k=window.localStorage;if(!k&&window.globalStorage){k=window.globalStorage[window.location.hostname]
}}}i=["SC.UserDefaults",f].join("-at-");if(k){if(SC.browser.msie=="7.0"){k.setAttribute(i.replace(/\W/gi,""),null);
k.save("SC.UserDefaults")}else{if(h){var c=this;h.transaction(function(e){e.executeSql("delete from SCLocalStorage where key = ?",[i],null)
});delete this.dataHash[i]}else{try{delete k[i]}catch(g){console.warn("Deleting local storage encountered a problem. "+g)
}}}}this.propertyDidChange(j);this.propertyDidChange(a);return this},unknownProperty:function(a,b){if(b===undefined){return this.readDefault(a)
...
j=SC.A(a).join(" ");if(!l){var o=document.createElement("div");SC.mixin(o.style,{position:"absolute",left:"0px",top:"0px",height:"0px",right:"0px",overflow:"hidden"});
l=this._metricsCalculationElement=document.createElement("div");o.appendChild(l);
document.body.insertBefore(o,null)}e=SC.$(l);if(SC.typeOf(p)!=SC.T_STRING){var h=null;
if(document.defaultView&&document.defaultView.getComputedStyle){h=document.defaultView.getComputedStyle(p,null)
}else{h=p.currentStyle}var n=this._copy_computed_props;for(var k=0;k<n.length;k++){var b=n[k],g=h[b];
l.style[b]=g}var m=l.style;if(m.font===""){var f="";if(m.fontStyle){f+=m.fontStyle+" "
}if(m.fontVariant){f+=m.fontVariant+" "}if(m.fontWeight){f+=m.fontWeight+" "}if(m.fontSize){f+=m.fontSize
}else{f+="10px"}if(m.lineHeight){f+="/"+m.lineHeight}f+=" ";if(m.fontFamily){f+=m.fontFamily
}else{m+="sans-serif"}l.style.font=f}SC.mixin(l.style,{left:"0px",top:"0px",position:"absolute",bottom:"auto",right:"auto",width:"auto",height:"auto"});
...
e=null;return a},metricsForString:function(c,e,f,b){SC.prepareStringMeasurement(e,f);
var a=SC.measureString(c,b);SC.teardownStringMeasurement();return a},viewportOffset:function(c){if(c.getBoundingClientRect){var e=c.getBoundingClientRect(),p=false;
...
}.property("parentObserver").cacheable(),length:0,objectAt:function(g,c){var h=this.get("length"),j=this.get("item"),a=this._objectAtCache,i=g,f=0,e,b;
if(g>=h){return undefined}if(this.get("isHeaderVisible")){if(g===0){return j}else{i--
}}j=null;if(!a){a=this._objectAtCache=[]}if((j=a[g])!==undefined){return j}b=this.get("children");
if(!b){return undefined}if(e=this.get("branchIndexes")){e.forEach(function(m){if(j||(m>i)){return
}var l=this.branchObserverAt(m),k;if(!l){return}k=l.get("length");if(m+k>i){j=l.objectAt(i-m,c);
i=-1}else{i-=k-1}},this)}if(i>=0){j=b.objectAt(i,c)}a[g]=j;return j},replace:function(a,b,k,e){var j=a,h=null,f,g,i;
...
b+=g.get("length")-1},this)}}return b}});sc_require("private/tree_item_observer");
...
}.observes("*arrangedObjects.[]"),canSelectGroups:NO,firstSelectableObject:function(){var e=this.get("arrangedObjects"),c,b,a=0;
if(!e){return null}if(this.get("canSelectGroups")){return e.get("firstObject")}c=e.contentGroupIndexes(null,e);
b=e.get("length");while(c.contains(a)&&(a<b)){a++}return a>=b?null:e.objectAt(a)}.property()});
...
},touchesDragged:function(a,c){var f=c[0];var b=(c.length>1||!this._candidateTouch||f.identifier!==this._candidateTouch.touch.identifier);
var e=this._calculateDragDistance(f)>this.get("tapWiggle");if(b||e){this._cancelTap(f)
...
this._SCAR_requestedBatchResizeId=a},measureSize:function(c){var f,e,h=this.get(this.get("autoResizeField")),b,g,a;
if(SC.none(h)||h===""){f={width:0,height:0}}else{if(c){f=SC.measureString(h)}else{e=this.kindOf(SC.TextFieldView)?this.$input()[0]:this.get("layer");
if(!e){return}f=SC.metricsForString(h,e)}}this.set("measuredSize",f);if(this.get("shouldAutoResize")){b=this.get("autoSizePadding");
if(SC.typeOf(b)===SC.T_NUMBER){g=a=b}else{g=b.height;a=b.width}if(this.get("shouldResizeWidth")){this.adjust("width",f.width+a)
}if(this.get("shouldResizeHeight")){this.adjust("height",f.height+g)}}this._SCAR_measurementPending=NO;
return f},_scar_valueDidChange:function(){this.measureSizeLater()},didAppendToDocument:function(){arguments.callee.base.apply(this,arguments);
this.measureSizeLater()},didCreateLayer:function(){arguments.callee.base.apply(this,arguments);
this.measureSizeLater()},needResize:null,untaggedViews:null,requestResize:function(b,f){if(SC.none(f)){var e=SC.AutoResize.untaggedViews||(SC.AutoResize.untaggedViews=SC.CoreSet.create());
e.add(b)}else{var c=SC.AutoResize.needResize||(SC.AutoResize.needResize={}),a=c[f]||(c[f]=SC.CoreSet.create());
...
if(b){b.remove(a)}},doBatchResize:function(){var a,c,b,e,f;f=SC.AutoResize.needResize;
for(a in f){c=f[a];while(b=c.pop()){e=b.get("layer");if(e){SC.prepareStringMeasurement(e);
...
},layoutDidChangeFor:function(h){if(!this._scfl_itemLayouts){return arguments.callee.base.apply(this,arguments)
}var b=this._scfl_itemLayouts[SC.guidFor(h)],a=h.get("layout"),e=h.get("frame");if(!b){return arguments.callee.base.apply(this,arguments)
}var g=YES;if(b.left&&b.left!==a.left){g=NO}else{if(b.top&&b.top!==a.top){g=NO}else{if(!h.get("fillWidth")&&b.width&&b.width!==a.width){g=NO
}else{if(!b.width&&!h.get("fillWidth")&&e.width!==h._scfl_lastFrame.width){g=NO}else{if(!h.get("fillHeight")&&b.height&&b.height!==a.height){g=NO
}else{if(!b.height&&!h.get("fillHeight")&&e.height!==h._scfl_lastFrame.height){g=NO
}}}}}}if(g){return arguments.callee.base.apply(this,arguments)}this.invokeOnce("_scfl_tile");
...
c.right=c.right||0;c.top=c.top||0;c.bottom=c.bottom||0}return c},flowSizeForView:function(a,c){var b=c.get("calculatedWidth"),g=c.get("calculatedHeight");
var e={},h=c.get("frame");c._scfl_lastFrame=h;if(b){e.width=b}else{if(c._scfl_cachedCalculatedFlowSize&&c._scfl_cachedCalculatedFlowSize.width==h.width){e.width=c._scfl_cachedFlowSize.width
}else{e.width=h.width}}if(g){e.height=g}else{if(c._scfl_cachedCalculatedFlowSize&&c._scfl_cachedCalculatedFlowSize.height==h.height){e.height=c._scfl_cachedFlowSize.height
}else{e.height=h.height}}if(c.get("isSpacer")){if(this.get("layoutDirection")===SC.LAYOUT_HORIZONTAL){e.width=0
}else{e.height=0}}if(this.get("layoutDirection")===SC.LAYOUT_HORIZONTAL&&c.get("fillHeight")){e.height=0
}else{if(this.get("layoutDirection")===SC.LAYOUT_VERTICAL&&c.get("fillWidth")){e.width=0
}}return e},flowRow:function(c,t,a,e,i,o,l,q){if(o==="left"){e-=i.left+i.right}else{e-=i.top+i.bottom
}var u,s=c.length,j,v,n=0,b=0,p=0;for(j=0;j<s;j++){u=c[j];if(u.get("isSpacer")){b+=u.get("spaceUnits")||1
}else{n+=u._scfl_cachedSpacedSize[o==="left"?"width":"height"]}}if(s>1&&q===SC.ALIGN_JUSTIFY){b+=s-1
}if(b>0){p=(e-n)/b;n=e}var h=i.left,g=i.top,m,k,f=0;if(o==="left"){g=t}else{h=t}if(q===SC.ALIGN_RIGHT||q===SC.ALIGN_BOTTOM){if(o==="left"){h=(e-n-i.right)
}else{g=(e-n-i.bottom)}}else{if(q===SC.ALIGN_CENTER||q===SC.ALIGN_MIDDLE){if(o==="left"){h=(e-i.top-i.bottom)/2-n/2
}else{g=(e-i.top-i.bottom)/2-n/2}}}for(j=0;j<s;j++){u=c[j];m=undefined;k=undefined;
if(u.get("fillHeight")&&o==="left"){k=a-u._scfl_cachedSpacedSize.height}if(u.get("fillWidth")&&o==="top"){m=a-u._scfl_cachedSpacedSize.width
}if(u.get("isSpacer")){f=u._scfl_cachedSpacedSize[o==="left"?"width":"height"];f=Math.max(f,p*(u.get("spaceUnits")||1));
if(o==="left"){m=f}else{k=f}}else{if(o==="left"){f=u._scfl_cachedSpacedSize.width
}else{f=u._scfl_cachedSpacedSize.height}}this.flowPositionView(j,u,h,g,m,k);if(o==="left"){h+=f
}else{g+=f}if(q===SC.ALIGN_JUSTIFY){if(o==="left"){h+=p}else{g+=p}}}if(o==="left"){return h
}return g},flowPositionView:function(g,j,f,e,a,i){var h=this._scfl_itemLayouts[SC.guidFor(j)],c=j._scfl_cachedSpacing;
var b={left:f+c.left,top:e+c.top};if(a!==undefined){b.width=a}if(i!==undefined){b.height=i
}this._scfl_itemLayouts[SC.guidFor(j)]=b;if(h&&h.left==b.left&&h.top==b.top&&h.width==b.width&&b.width!==undefined&&h.height==b.height&&b.height!==undefined){return
}j.adjust(b)},renderMixin:function(a){a.css("minWidth",this.get("calculatedWidth"));
...
}var l=this._scfl_isObserving||SC.CoreSet.create(),H=SC.CoreSet.create();var f=this.get("childViews"),g,v,D=f.length,n=[],i=[],G=0,a=0,q,h=NO,E=0,m=0,z=this.get("frame").width,w=this.get("frame").height,p=this.get("canWrap"),F=this.get("layoutDirection"),t=this.get("_scfl_validFlowPadding"),b,B,e,C=this.get("align"),u=0;
var A,y,j,x,c,o,s,k;if(F===SC.LAYOUT_HORIZONTAL){k=z;s=z-t.right;A="left";x="top";
y="right";c="bottom";j="width";o="height"}else{k=w;s=w-t.bottom;A="top";x="left";
y="bottom";c="right";j="height";o="width"}E=t[x];m=t[A];for(v=0;v<D;v++){g=f[v];l.remove(SC.guidFor(g));
H.add(g);q=g.get("startsNewRow");if(!this.shouldIncludeChildInFlow(g)){h=q||h;continue
}b=this.flowSizeForView(v,g);B=this.flowSpacingForView(v,g);e={width:b.width+B.left+B.right,height:b.height+B.top+B.bottom};
g._scfl_cachedFlowSize=b;g._scfl_cachedSpacedSize=e;g._scfl_cachedSpacing=B;if(q||h||(p&&i.length>0&&m+b[j]>=s)){h=NO;
this.flowRow(i,E,a,k,t,A,x,C);i=[];n.push(i);E+=a;a=G;m=t[A]}i.push(g);a=Math.max(e[o],a);
m+=e[j];u=Math.max(u,m)}m=this.flowRow(i,E,a,k,t,A,x,C);u=Math.max(u,m);this._scfl_lastFrameSize=this.get("frame");
if(this.get("autoResize")){if(u){if(F===SC.LAYOUT_HORIZONTAL){if(this.get("shouldResizeWidth")){this.set("calculatedWidth",u+t[y])
}}else{if(this.get("shouldResizeHeight")){this.set("calculatedHeight",u+t[y])}}}if(E+a){if(F===SC.LAYOUT_HORIZONTAL){if(this.get("shouldResizeHeight")){this.set("calculatedHeight",E+a+t[c])
}}else{if(this.get("shouldResizeWidth")){this.set("calculatedWidth",E+a+t[c])}}}}D=l.length;
for(v=0;v<D;v++){this.unobserveChildLayout(l[v])}D=H.length;for(v=0;v<D;v++){this.observeChildLayout(H[v])
}this._scfl_isObserving=H},_scfl_frameDidChange:function(){var b=this.get("frame"),a=this._scfl_lastFrameSize;
...
}var c=b.length,e=this.childViews,a;this.beginPropertyChanges();while(c-->0){a=b[c];
e.removeObject(a);e.unshiftObject(a)}this.endPropertyChanges();this._scfl_childViewsDidChange();
...
for(b=0;b<a;b++){c=e[b];c.unassignedTouchDidEnd(f)}}};SC.InlineEditable={editorDelegate:null,isEditable:YES,isEditing:NO,beginEditing:function(){if(this.get("isEditing")){return YES
...
}if(c.get("isEditing")){return YES}var e=c.$(),h=c.get("value")||"",g=SC.viewportOffset(e[0]),a=c.convertFrameFromView(c.get("frame"),null),i=this.get("exampleInlineTextFieldView");
g.width=a.width;g.height=a.height;c.inlineEditorWillBeginEditing();i.beginEditing({pane:c.get("pane"),frame:g,layout:c.get("layout"),exampleInlineTextFieldView:i,delegate:this,inlineEditorClassName:this.get("inlineEditorClassName"),exampleElement:e,value:b,multiline:this.get("isInlineEditorMultiline"),isCollection:NO});
i.editor._target=c},parentViewForEditor:function(a){return a.get("parentView")},commitEditingFor:function(a){if(!a.get("isEditing")){return NO
...
}.observes("isTextArea"),shouldRenderBorder:YES,_renderField:function(c,j,p,h,m){var n=this.get("hint"),f,v,q,e,s,b,k,g,o=this.get("spellCheckEnabled"),u,i=this.get("maxLength"),a;
...
v=this.get("layerId");if(this.get("shouldRenderBorder")){c.push('<span class="border"></span>')
}q="";if(h||m){q='style="';if(h){q+="left: "+h+"; "}if(m){q+="right: "+m+";"}q+='"'
}c.push('<span class="padding" '+q+">");p=this.get("escapeHTML")?SC.RenderContext.escapeHTML(p):p;
if(!this.get("_supportsPlaceHolder")&&(!p||(p&&p.length===0))){p=this.get("hint");
...
}if(this.get("isEditing")){return NO}var e={},g,b,f,a;a=c.delegate;this.set("editorDelegate",a);
...
this.set("validator",c.validator);this.set("value",this._originalValue);g=c.pane;
e.height=this._optframe.height;e.width=this._optframe.width;b=c.layout;f=g.$()[0];
if(this._optIsCollection&&b.left){e.left=this._optframe.x-b.left-f.offsetLeft-1;if(SC.browser.msie==7){e.left--
}}else{e.left=this._optframe.x-f.offsetLeft-1;if(SC.browser.msie==7){e.left--}}if(this._optIsCollection&&b.top){e.top=this._optframe.y-b.top-f.offsetTop;
if(SC.browser.msie==7){e.top=e.top-2}}else{e.top=this._optframe.y-f.offsetTop;if(SC.browser.msie==7){e.top=e.top-2
}}this.set("layout",e);this.set("parentNode",g);g.appendChild(this);this._className=c.inlineEditorClassName;
if(this._className&&!this.hasClassName(this._className)){this.setClassName(this._className,true)
}this._previousFirstResponder=g?g.get("firstResponder"):null;this.becomeFirstResponder();
...
},_endEditing:function(e,b,c){var a=this.get("editorDelegate");if(!this.get("isEditing")||!a){return YES
}if(!a.inlineEditorShouldCommitEditing(this,e)){SC.Logger.warn("InlineTextField._endEditing() cannot end without inlineEditorShouldCommitEditing() on the delegate.");
return NO}a.inlineEditorDidEndEditing(this,e);if(this._className){this.setClassName(this._className,false)
...
var a=b.exampleInlineTextFieldView?b.exampleInlineTextFieldView:this,g=b.layout,f=this.updateViewStyle(),h=this.updateViewPaddingStyle();
...
}},_htmlForTitleAndIcon:function(f){var e=f.get("title"),c=f.get("hint"),b=f.get("escapeHTML"),a=f.get("icon")||"";
if(e&&b){e=SC.RenderContext.escapeHTML(e)}if(c&&!e){if(b){c=SC.RenderContext.escapeHTML(c)
}e="<span class='sc-hint'>"+c+"</span>"}if(a){if(a.indexOf("/")>=0){a='<img src="'+a+'" alt="" class="icon" />'
}else{a='<img src="'+SC.BLANK_IMAGE_URL+'" alt="" class="icon '+a+'" />'}}return a+e
...
}var e=this._images[c];if(!e&&a){var b=new Image();e=this._images[c]={url:c,status:this.IMAGE_WAITING,callbacks:[],retainCount:0,image:b};
...
b=c.substring(0,c.indexOf("1")+1)}e=e.valueOf();return Math.round(e*b)/b}});SC.LOG_MODULE_LOADING=YES;
SC.Module=SC.Object.create({isModuleReady:function(a){var b=SC.MODULE_INFO[a];return b?!!b.isReady:NO
},loadModule:function(b,h,a){var c=SC.MODULE_INFO[b],i,g;var j=SC.A(arguments).slice(3);
var e=SC.LOG_MODULE_LOADING;var k,f;if(a===undefined&&SC.typeOf(h)===SC.T_FUNCTION){a=h;
h=null}if(e){console.log("SC.Module: Attempting to load '%@'".fmt(b))}if(!c){throw"SC.Module: could not find module '%@'".fmt(b)
}c.isPrefetching=NO;if(c.isLoaded){if(e){console.log("SC.Module: Module '%@' already loaded.".fmt(b))
}if(c.source){if(e){console.log("SC.Module: Evaluating JavaScript for module '%@'.".fmt(b))
}this._evaluateStringLoadedModule(c)}if(a){if(SC.isReady){SC.Module._invokeCallback(b,h,a,j)
}else{SC.ready(SC.Module,function(){SC.Module._invokeCallback(b,h,a,j)})}}}else{if(e){console.log("SC.Module: Module '%@' is not loaded, loading now.".fmt(b))
}i=c.callbacks||[];if(a){i.push(function(){SC.Module._invokeCallback(b,h,a,j)})}c.callbacks=i;
...
b.isLoading=YES;b.isPrefetching=YES},_executeLazilyInstantiatedModule:function(b,c,j){var i=SC.LAZY_INSTANTIATION[b];
var h;var a;var k,f;if(SC.LOG_MODULE_LOADING){console.log("SC.Module: Module '%@' is marked for lazy instantiation, instantiating it now…".fmt(b))
}f=i.length;for(k=0;k<f;k++){try{i[k]()}catch(g){console.error("SC.Module: Failed to lazily instatiate entry for  '%@'".fmt(b))
}}delete SC.LAZY_INSTANTIATION[b];h=this._targetForTargetName(c);a=this._methodForMethodNameInTarget(j,h);
...
b.isReady=YES},_loadCSSForModule:function(e){var g=document.getElementsByTagName("head")[0];
var f=SC.MODULE_INFO[e];var i=f.styles||[];var b=i.length;var c;var h;var a;if(!g){g=document.documentElement
}b=i.length;for(a=0;a<b;a++){c=i[a];if(c.length>0){if(SC.LOG_MODULE_LOADING){console.log("SC.Module: Loading CSS file in '%@' -> '%@'".fmt(e,c))
}h=document.createElement("link");h.setAttribute("href",c);h.setAttribute("rel","stylesheet");
h.setAttribute("type","text/css");g.appendChild(h)}}h=null},_loadJavaScriptForModule:function(b){var c=SC.MODULE_INFO[b];
var e;var a;var f=c.dependencies;var g=YES;if(f&&f.length>0){g=this._dependenciesMetForModule(b)
}if(c.isPrefetched){a=c.stringURL}else{if(g){a=c.scriptURL}else{a=c.stringURL}}if(a.length>0){if(SC.LOG_MODULE_LOADING){console.log("SC.Module: Loading JavaScript file in '%@' -> '%@'".fmt(b,a))
}e=document.createElement("script");e.setAttribute("type","text/javascript");e.setAttribute("src",a);
e.onload=function(){SC.Module._moduleDidLoad(b)};document.body.appendChild(e)}},_dependenciesMetForModule:function(c){var f=SC.MODULE_INFO[c].dependencies||[];
var b,a=f.length;var g;var e;for(b=0;b<a;b++){g=f[b];e=SC.MODULE_INFO[g];if(!e){throw"SC.loadModule: Unable to find dependency %@ for module %@.".fmt(g,c)
}if(!e.isReady){return NO}}return YES},_loadDependenciesForModule:function(a){var b=SC.MODULE_INFO[a];
var f=SC.LOG_MODULE_LOADING;var j=b.dependencies||[];var g=YES;var h=j.length;var k;
var e;var c;var i;for(k=0;k<h;k++){e=j[k];c=SC.MODULE_INFO[e];if(!c){throw"SC.Module: could not find required module '%@' for module '%@'".fmt(e,a)
}else{if(c.isLoading){g=NO;i=c.dependents;if(!i){c.dependents=i=[]}i.push(a)}else{if(c.isReady){continue
}else{g=NO;i=c.dependents;if(!i){c.dependents=i=[]}i.push(a);if(f){console.log("SC.Module: '%@' depends on '%@', loading dependency…".fmt(a,e))
}SC.Module.loadModule(e)}}}}},_invokeCallback:function(c,e,a,b){var h;var g;g=this._targetForTargetName(e);
h=this._methodForMethodNameInTarget(a,g);if(!h){if(SC.LAZY_INSTANTIATION[c]){this._executeLazilyInstantiatedModule(c,e,a)
}else{throw"SC.Module: could not find callback for '%@'".fmt(c)}}if(!b){b=[]}b.unshift(c);
var f=!!SC.RunLoop.currentRunLoop;if(f){SC.run(function(){h.apply(g,b)})}else{h.apply(g,b)
}},_invokeCallbacksForModule:function(c){var f=SC.MODULE_INFO[c],e;if(!f){return}if(SC.LOG_MODULE_LOADING){console.log("SC.Module: Module '%@' has completed loading, invoking callbacks.".fmt(c))
}e=f.callbacks||[];for(var b=0,a=e.length;b<a;++b){e[b]()}},_evaluateAndInvokeCallbacks:function(a){var c=SC.MODULE_INFO;
var b=c[a];var e=SC.LOG_MODULE_LOADING;if(e){console.log("SC.Module: Evaluating and invoking callbacks for '%@'.".fmt(a))
...
delete b.callbacks})}var h=b.dependents||[];var f,j;for(var i=0,g=h.length;i<g;i++){f=h[i];
j=c[f];if(j.isLoaded&&this._dependenciesMetForModule(f)){if(e){console.log("SC.Module: Now that %@ has loaded, all dependencies for a dependent %@ are met.".fmt(a,f))
}this._evaluateAndInvokeCallbacks(f)}}},_moduleDidLoad:function(b){var c=SC.MODULE_INFO[b];
var f=SC.LOG_MODULE_LOADING;var e;var g,a;if(f){console.log("SC.Module: Module '%@' finished loading.".fmt(b))
}if(!c){if(f){console.log("SC._moduleDidLoad() called for unknown module '@'.".fmt(b))
}c=SC.MODULE_INFO[b]={isLoaded:YES,isReady:YES};return}if(c.isLoaded){if(f){console.log("SC._moduleDidLoad() called more than once for module '%@'. Skipping.".fmt(b))
}return}delete c.isLoading;c.isLoaded=YES;if(!c.isPrefetching){e=this._dependenciesMetForModule(b);
if(e){this._evaluateAndInvokeCallbacks(b)}else{if(f){console.log("SC.Module: Dependencies for '%@' not met yet, waiting to evaluate.".fmt(b))
}}}else{delete c.isPrefetching;if(f){console.log("SC.Module: Module '%@' was prefetched, not evaluating until needed.".fmt(b))
...
}return a}});SC.ready(function(){var f=SC.MODULE_INFO;var c;var e;var a;for(c in f){e=f[c];
if(e.isPrefetched){var b=c;a=SC.Task.create({run:function(){SC.Module.prefetchModule(b)
...
this.set("errorObject",e)}this.set("status",b)},this);if(!SC.browser.msie&&!SC.browser.opera){SC.Event.remove(f,"readystatechange",this,this.finishRequest)
...
this.fireRequestIfNeeded()}});SC.routes=SC.Object.create({_didSetup:NO,_location:null,_firstRoute:null,_extractParametersAndRoute:function(c){var a={},j=c.route||"",f,b,e,h,g,k;
...
}else{return e.match(/^[0-9\0]*/)[0]===e}}});SC.ContainerView=SC.View.extend({classNames:["sc-container-view"],renderDelegateName:"containerRenderDelegate",nowShowing:null,contentView:null,contentViewBindingDefault:SC.Binding.single(),replaceContent:function(a){this.removeAllChildren();
...
}c.attr("src",f);var b=this.get("displayToolTip");if(SC.typeOf(b)===SC.T_STRING){c.attr("title",b);
...
if(c){if(this._hasLegacyActionHandler()){this._triggerLegacyActionHandler(a)}else{if(b){b.sendAction(c,e,this,this.get("pane"),null,this)
...
}},didAppendToDocument:function(){if(parseInt(SC.browser.msie,0)===7&&this.get("useStaticLayout")){var f=this.get("layout"),e=this.$(),a=0;
...
})}return b},render:function(b,f){arguments.callee.base.apply(this,arguments);var c,a,o,q,v,g,t,h,m,u,l,e,j,w,p,n,s,k,i;
c=this.layout.width;if(f&&c){this.adjust({width:c-this.SELECT_BUTTON_SPRITE_WIDTH})
}a=this.get("objects");a=this.sortObjects(a);o=a.length;q=this.get("nameKey");v=this.get("iconKey");
g=this.get("valueKey");i=this.get("isEnabledKey");t=this.get("checkboxEnabled");h=this.get("value");
m=this.get("localize");u=this.get("separatorPosition");l=[];e=YES;j=0;a.forEach(function(x){if(x){w=q?(x.get?x.get(q):x[q]):x.toString();
w=m?w.loc():w;p=v?(x.get?x.get(v):x[v]):null;if(SC.none(x[v])){p=null}n=(g)?(x.get?x.get(g):x[g]):x;
if(!SC.none(h)&&!SC.none(n)){if(this._equals(h,n)){this.set("title",w);this.set("icon",p)
}}if(this._equals(n,this.get("value"))){if(u>0&&u<o&&j>=o-u){j++}this.set("itemIdx",j);
e=!t?NO:YES}else{e=NO}k=(i)?(x.get?x.get(i):x[i]):x;if(NO!==k){k=YES}if(j===0){this._defaultVal=n;
this._defaultTitle=w;this._defaultIcon=p}var y=SC.Object.create({title:w,icon:p,value:n,isEnabled:k,checkbox:e,target:this,action:"displaySelectedItem"});
l.push(y)}j+=1;if(u&&j===(o-u)){var z=SC.Object.create({separator:YES});l.push(z)
...
},_equals:function(b,a){var c=YES;if(b&&SC.typeOf(b)===SC.T_HASH&&a&&SC.typeOf(a)===SC.T_HASH){for(var e in b){if(b[e]!==a[e]){c=NO
}}}else{c=(b===a)}return c},_action:function(p){var j,a,m,n,v,s,C,f,B,c,q,w,t,z,g,h,o,b,A,i,l,D,k;
j=this.$(".sc-button-label")[0];D=SC.SelectButtonView.MENU_WIDTH_OFFSET;if(!this.get("isDefaultPosition")){switch(this.get("controlSize")){case SC.TINY_CONTROL_SIZE:D+=SC.SelectButtonView.TINY_POPUP_MENU_WIDTH_OFFSET;
...
this.set("itemIdx",b.get("contentIndex"));return YES},changeSelectButtonPreferMatrix:function(){var b=0,i=0,e=0,f=0,j,g;
switch(this.get("controlSize")){case SC.TINY_CONTROL_SIZE:b=SC.SelectButtonView.TINY_OFFSET_Y;
i=SC.MenuPane.TINY_MENU_ITEM_HEIGHT;e=SC.MenuPane.TINY_MENU_ITEM_SEPARATOR_HEIGHT;
break;case SC.SMALL_CONTROL_SIZE:b=SC.SelectButtonView.SMALL_OFFSET_Y;i=SC.MenuPane.SMALL_MENU_ITEM_HEIGHT;
e=SC.MenuPane.SMALL_MENU_ITEM_SEPARATOR_HEIGHT;break;case SC.REGULAR_CONTROL_SIZE:b=SC.SelectButtonView.REGULAR_OFFSET_Y;
i=SC.MenuPane.REGULAR_MENU_ITEM_HEIGHT;e=SC.MenuPane.REGULAR_MENU_ITEM_SEPARATOR_HEIGHT;
break;case SC.LARGE_CONTROL_SIZE:b=SC.SelectButtonView.LARGE_OFFSET_Y;i=SC.MenuPane.LARGE_MENU_ITEM_HEIGHT;
e=SC.MenuPane.LARGE_MENU_ITEM_SEPARATOR_HEIGHT;break;case SC.HUGE_CONTROL_SIZE:b=SC.SelectButtonView.HUGE_OFFSET_Y;
i=SC.MenuPane.HUGE_MENU_ITEM_HEIGHT;e=SC.MenuPane.HUGE_MENU_ITEM_SEPARATOR_HEIGHT;
break}var h=b,a=this.get("itemIdx"),l=this.get("leftAlign"),k,c;if(this.get("isDefaultPosition")){k=[1,0,3];
this.set("preferMatrix",k)}else{if(a){h=a*i+b;j=this.get("separatorPosition");g=this.get("objects").length;
if(j>0&&j<g&&a>=g-j){f=i-e;h-=f}}c=[l,-h,2];this.set("preferMatrix",c)}},mouseDown:function(a){if(!this.get("isEnabled")){return YES
...
SC.BaseTheme.buttonRenderDelegate=SC.RenderDelegate.create({name:"button",render:function(h,c){var g=h.get("theme"),f=h.get("titleMinWidth"),b=h.get("displayToolTip"),a=h.get("view");
var e;c.setClass("icon",!!h.get("icon")||0);c.setClass("def",h.get("isDefault")||0);
c.setClass("cancel",h.get("isCancel")||0);if(b){c.attr("title",b);c.attr("alt",b)
}f=(f?"style='min-width: "+f+"px'":"");c=c.push("<span class='sc-button-inner' "+f+">");
c=c.begin("label").addClass("sc-button-label");g.labelRenderDelegate.render(h,c);
c=c.end();c.push("</span>");if(h.get("supportFocusRing")){c.push('<div class="focus-ring">','<div class="focus-left"></div>','<div class="focus-middle"></div>','<div class="focus-right"></div></div>')
...
}});SC.BaseTheme.checkboxRenderDelegate=SC.RenderDelegate.create({name:"checkbox",render:function(g,c){var f=g.get("theme");
var b=g.get("isSelected")||NO;var e=g.get("isActive");var a=!g.get("isEnabled");c.attr("role","checkbox");
c.attr("aria-checked",b.toString());c.setClass({sel:b,active:e,disabled:a});c.push('<span class = "button"></span>');
c=c.begin("span").addClass("label");f.labelRenderDelegate.render(g,c);c=c.end()},update:function(g,b){var f=g.get("theme");
var c=g.get("isSelected");var e=g.get("isActive");var a=!g.get("isEnabled");b.attr("aria-checked",c.toString());
f.labelRenderDelegate.update(g,b.find("span.label"));b.setClass({sel:c,active:e,disabled:a})
...
a.setClass("active",b.get("isActive"))}});SC.BaseTheme.disclosureRenderDelegate=SC.RenderDelegate.create({name:"disclosure",render:function(e,a){var c=e.get("theme");
if(e.get("isSelected")){a.addClass("sel")}var b="";b+=e.get("isSelected")?"open":"closed";
if(e.get("isActive")){b+=" active"}a.push('<img src = "'+SC.BLANK_IMAGE_URL+'" class = "disclosure button '+b+'" />');
a=a.begin("span").addClass("sc-button-label");c.labelRenderDelegate.render(e,a);a=a.end()
...
SC.mixin(SC.RenderDelegate.prototype,{includeSlices:function(f,c,e){for(var b=0,a=e.length;
b<a;b++){c.push('<div class="'+e[b]+'"></div>')}}});SC.BaseTheme.imageButtonRenderDelegate=SC.RenderDelegate.create({name:"image-button",render:function(c,a){var b=c.get("image");
...
},update:function(){}});sc_require("render_delegates/panel");SC.BaseTheme.menuRenderDelegate=SC.RenderDelegate.create({name:"menu",render:function(g,c){var a=g.get("theme").panelRenderDelegate;
a.render(g,c);var b=g.get("preferType");var f=g.get("pointerPos");var e=g.get("pointerPosY");
if(b==SC.PICKER_POINTER||b==SC.PICKER_MENU_POINTER){c.push('<div class="sc-pointer '+f+'" style="margin-top: '+e+'px"></div>');
c.addClass(f)}},update:function(h,g){var a=h.get("theme").panelRenderDelegate;a.update(h,g);
var b=h.get("preferType");var f=h.get("pointerPos");var e=h.get("pointerPosY");if(b==SC.PICKER_POINTER||b==SC.PICKER_MENU_POINTER){var c=g.find(".sc-pointer");
c.attr("class","sc-pointer "+f);c.attr("style","margin-top: "+e+"px");g.addClass(f)
}}});sc_require("render_delegates/panel");SC.BaseTheme.pickerRenderDelegate=SC.RenderDelegate.create({name:"picker",render:function(g,c){var a=g.get("theme").panelRenderDelegate;
a.render(g,c);var b=g.get("preferType");var f=g.get("pointerPos");var e=g.get("pointerPosY");
if(b==SC.PICKER_POINTER||b==SC.PICKER_MENU_POINTER){c.push('<div class="sc-pointer '+f+'" style="margin-top: '+e+'px"></div>');
c.addClass(f)}},update:function(h,g){var a=h.get("theme").panelRenderDelegate;a.update(h,g);
var b=h.get("preferType");var f=h.get("pointerPos");var e=h.get("pointerPosY");if(b==SC.PICKER_POINTER||b==SC.PICKER_MENU_POINTER){var c=g.find(".sc-pointer");
...
SC.BaseTheme.progressRenderDelegate=SC.RenderDelegate.create({render:function(b,c){var j=b.get("theme");
var p,g,m=b.get("value")*100,e,i,f=b.get("isIndeterminate"),o=b.get("isRunning"),l=b.get("isEnabled"),n=j.PROGRESS_OFFSET_RANGE,h=(f&&o)?(Math.floor(Date.now()/75)%n-n):0;
...
}this._hasGivenOffsetRangeDeprecationWarning=YES;n=b.get("offsetRange")}var a={"sc-indeterminate":f,"sc-empty":(m<=0),"sc-complete":(m>=100)};
if(!l){m="0%"}else{if(f){m="120%"}else{m=m+"%"}}var k=this._createClassNameString(a);
...
},update:function(b,j){var i=b.get("theme");var o,l,c,h,f=i.PROGRESS_ANIMATED_BACKGROUND_MATRIX,e=b.get("isIndeterminate"),n=b.get("isRunning"),k=b.get("isEnabled"),m=b.get("offsetRange"),g=(e&&n)?(Math.floor(Date.now()/75)%m-m):0;
if(!k){l="0%"}else{if(e){l="120%"}else{l=(b.get("value")*100)+"%"}}var a={"sc-indeterminate":e,"sc-empty":(l<=0),"sc-complete":(l>=100)};
j.setClass(a);o=j.find(".sc-inner");if(b.get("animatedBackgroundMatrix")){if(!this._hasGivenAnimatedBackgroundDeprecationWarning){console.warn("The 'animatedBackgroundMatrix' property for progressRenderDelegate is deprecated. Please override the value on your theme by setting its PROGRESS_ANIMATED_BACKGROUND_MATRIX property.")
}this._hasGivenAnimatedBackgroundDeprecationWarning=YES;f=b.get("animatedBackgroundMatrix")
}if(!f){f=i.PROGRESS_ANIMATED_BACKGROUND_MATRIX}c="width: "+l+"; ";c=c+"left: "+g+"px; ";
if(f.length===3){o.css("backgroundPosition","0px -"+(f[0]+f[1]*this._currentBackground)+"px");
if(this._currentBackground===f[2]-1||this._currentBackground===0){this._nextBackground*=-1
}this._currentBackground+=this._nextBackground;c=c+"backgroundPosition: "+h+"px; ";
o.attr("style",c)}else{o.attr("style",c)}},_createClassNameString:function(c){var b=[],a;
for(a in c){if(!c.hasOwnProperty(a)){continue}if(c[a]){b.push(a)}}return b.join(" ")
}});SC.BaseTheme.radioRenderDelegate=SC.RenderDelegate.create({name:"radio",render:function(f,b){var e=f.get("theme");
var a=f.get("isSelected"),c=f.get("width");b.setClass({active:f.get("isActive"),mixed:f.get("isMixed"),sel:f.get("isSelected"),disabled:!f.get("isEnabled")});
b.attr("role","radio");b.attr("aria-checked",a);if(c){b.css("width",c)}b.push('<span class = "button"></span>');
b=b.begin("span").addClass("sc-button-label");e.labelRenderDelegate.render(f,b);b=b.end()
},update:function(f,a){var e=f.get("theme");var b=f.get("isSelected"),c=f.get("width");
a.setClass({active:f.get("isActive"),mixed:f.get("isMixed"),sel:f.get("isSelected"),disabled:!f.get("isEnabled")});
a.attr("aria-checked",b);a.css("width",c?c:null);e.labelRenderDelegate.update(f,a.find(".sc-button-label"))
}});SC.BaseTheme.radioGroupRenderDelegate=SC.RenderDelegate.create({name:"radio-group",render:function(i,f){var h=i.get("theme"),e=SC.guidFor(this),c=i.get("items"),b,a=c.length,g;
f.addClass(i.get("layoutDirection"));f.attr("role","radiogroup");for(b=0;b<a;b++){g=c[b];
f=f.begin("div").addClass("radio-"+b).attr("index",b).addClass(h.classNames).addClass(h.radioRenderDelegate.name).addClass("sc-radio-button");
h.radioRenderDelegate.render(g,f);f=f.end()}i.get("renderState").radioCount=b},update:function(a,e){var f=a.get("theme"),b=SC.guidFor(this),h=a.get("items"),i,g=h.length,j;
e.addClass(a.get("layoutDirection"));if(a.get("renderState").radioCount!==g){var c=SC.RenderContext(e[0]);
this.render(a,c);c.update();return}for(i=0;i<g;i++){j=h[i];f.radioRenderDelegate.update(j,e.find(".radio-"+i))
}},updateRadioAtIndex:function(e,a,b){var c=e.get("items")[b];e.get("theme").radioRenderDelegate.update(c,a.find(".radio-"+b))
},indexForEvent:function(e,b,a){var c=$(a.target).closest(".sc-radio-button").attr("index");
if(isNaN(c)){return undefined}return parseInt(c,0)}});SC.BaseTheme.segmentRenderDelegate=SC.Object.create({name:"segment",render:function(f,b){var c=f.get("theme"),e,a;
a={"sc-segment":YES,"sc-first-segment":f.get("isFirstSegment"),"sc-middle-segment":f.get("isMiddleSegment"),"sc-last-segment":f.get("isLastSegment"),"sc-overflow-segment":f.get("isOverflowSegment")};
a["sc-segment-"+f.get("index")]=YES;b.setClass(a);e=c.buttonRenderDelegate;e.render(f,b)
},update:function(g,a){var e=g.get("theme"),f,c,b={};b={"sc-segment":YES,"sc-first-segment":g.get("isFirstSegment"),"sc-middle-segment":g.get("isMiddleSegment"),"sc-last-segment":g.get("isLastSegment"),"sc-overflow-segment":g.get("isOverflowSegment")||NO};
b["sc-segment-"+g.get("index")]=YES;a.setClass(b);f=e.buttonRenderDelegate;f.update(g,a)
...
},indexForClientPosition:function(a,j,g){var f=a.$(".sc-segment"),b,e,c,h,k;k={x:j,y:g};
for(e=0,b=f.length;e<b;e++){c=f[e];h=c.getBoundingClientRect();h.x=h.left;h.y=h.top;
if(SC.pointInRect(k,h)){return e}}return -1}});SC.BaseTheme.sliderRenderDelegate=SC.RenderDelegate.create({name:"slider",render:function(c,b){var a=SC.BLANK_IMAGE_URL;
...
}var i=this.event;var f={x:i.pageX,y:i.pageY};this.set("location",f);if(this.get("sourceIsDraggable")){var b=this._getDragView();
...
}}if(e&&e.dragDidMove){e.dragDidMove(this,g)}if(this.get("sourceIsDraggable")&&!this._ghostViewHidden){this._positionGhostView(a)
...
}this.$label().css("opacity",this._oldOpacity);this.displayDidChange()},render:function(c,a){var g=this.get("content"),n=this.displayDelegate,b=this.get("outlineLevel"),f=this.get("outlineIndent"),m,k,j,o=[];
...
if(m){k=g?(g.get?g.get(m):g[m]):NO;if(k!==null){this.renderCheckbox(j,k);o.push("has-checkbox")
}}if(this.getDelegateProperty("hasContentIcon",n)){m=this.getDelegateProperty("contentIconKey",n);
k=(m&&g)?(g.get?g.get(m):g[m]):null;this.renderIcon(j,k);o.push("has-icon")}else{if(this.get("icon")){k=this.get("icon");
this.renderIcon(j,k);o.push("has-icon")}}m=this.getDelegateProperty("contentValueKey",n);
...
c=j.end()},renderDisclosure:function(a,e){var c=this.get("theme").disclosureRenderDelegate;
...
}b.set("isSelected",e===SC.BRANCH_OPEN).set("isEnabled",this.get("isEnabled")).set("title","");
c.render(b,a);a=a.end();this._disclosureRenderDelegate=c},renderCheckbox:function(a,e){var c=this.get("theme").checkboxRenderDelegate;
...
}b.set("isSelected",e&&(e!==SC.MIXED_STATE)).set("isEnabled",this.get("isEnabled")&&this.get("contentIsEditable")).set("isActive",this._checkboxIsActive).set("title","");
c.render(b,a);a=a.end();this._checkboxRenderDelegate=c},renderIcon:function(c,f){var b=null,e=null,a=[];
...
},renderRightIcon:function(c,f){var b=null,e=null,a=[];if(f&&SC.ImageView.valueIsUrl(f)){b=f;
e=""}else{e=f;b=SC.BLANK_IMAGE_URL}a.push("right-icon",e);c.begin("img").addClass(a).attr("src",b).end()
...
},displayProperties:"isFirstResponder isEnabled isActive".w(),renderDelegateName:"collectionRenderDelegate",_TMP_ATTRS:{},_COLLECTION_CLASS_NAMES:"sc-collection-item".w(),_GROUP_COLLECTION_CLASS_NAMES:"sc-collection-item sc-group-item".w(),_VIEW_POOL:null,_GROUP_VIEW_POOL:null,itemViewForContentIndex:function(m,a){var x;
...
this._lastHoveredItem=null;if(a&&a.mouseExited){a.mouseExited(b)}return YES},touchStart:function(h,a){if(this.get("useToggleSelection")){return true
...
if(!this._masterIsDrawn){if(this._picker){this._picker.set("contentView",null)}this.appendChild(e);
this._masterIsDrawn=YES}e.set("layout",{left:0,top:0,bottom:0,width:f});var a=this.getThemedProperty("dividerWidth","MASTER_DETAIL_DIVIDER_WIDTH");
c.set("layout",{left:f+a,right:0,top:0,bottom:0})}else{if(this._masterIsDrawn){this.removeChild(e);
...
if(a){b=c.calculatedWidth}b*=this._scale;var e=this.get("containerView").get("frame").width;
if(!this.get("canScrollHorizontal")){b=Math.min(b,e)}return this.maximumScrollOffset(b,e,this.get("horizontalAlign"))
...
if(b){c=b}c*=this._scale;var e=this.get("containerView").get("frame").height;if(!this.get("canScrollVertical")){c=Math.min(c,e)
}return this.maximumScrollOffset(c,e,this.get("verticalAlign"))}.property(),minimumHorizontalScrollOffset:function(){var c=this.get("contentView");
var b=c?c.get("frame").width:0,a=c?c.get("calculatedWidth"):0;if(a){b=a}b*=this._scale;
var e=this.get("containerView").get("frame").width;if(!this.get("canScrollHorizontal")){b=Math.min(b,e)
}return this.minimumScrollOffset(b,e,this.get("horizontalAlign"))}.property(),minimumVerticalScrollOffset:function(){var a=this.get("contentView");
var c=(a&&a.get("frame"))?a.get("frame").height:0,b=a?a.get("calculatedHeight"):0;
if(b){c=a.calculatedHeight}c*=this._scale;var e=this.get("containerView").get("frame").height;
if(!this.get("canScrollVertical")){c=Math.min(c,e)}return this.minimumScrollOffset(c,e,this.get("verticalAlign"))
...
this._applyCSSTransforms(b.layer);this._touchScrollDidChange();var q=b.decelerationRate;
b.decelerationVelocity.y*=Math.pow(q,(e/10));b.decelerationVelocity.x*=Math.pow(q,(e/10));
b.decelerationVelocity.x=this.bouncyBounce(b.decelerationVelocity.x,o,u,h,n,p,0.3);
...
if(c<0.05&&m<0.05&&Math.abs(i)<0.05){b.timeout=null;this.touch=null;this._touchScrollDidEnd();
...
return}var f=this;b.lastEventTime=Date.now();this.touch.timeout=setTimeout(function(){SC.run(f.decelerateAnimation(),f)
...
if(e!==a){if(a){a.removeObserver("calculatedWidth",this,this.contentViewFrameDidChange);
a.removeObserver("calculatedHeight",this,this.contentViewFrameDidChange);a.removeObserver("frame",this,b);
a.removeObserver("layer",this,c)}this._scroll_contentView=e;if(e){e.addObserver("frame",this,b);
e.addObserver("calculatedWidth",this,this.contentViewFrameDidChange);e.addObserver("calculatedHeight",this,this.contentViewFrameDidChange);
e.addObserver("layer",this,c)}this.containerView.set("contentView",e);this.contentViewFrameDidChange()
...
},oldMaxHOffset:0,oldMaxVOffset:0,contentViewFrameDidChange:function(b){var o=this.get("contentView"),m=(o)?o.get("frame"):null,i=this._scale,c=0,q=0,k,j,n;
if(o){c=o.get("calculatedWidth")||m.width||0;q=o.get("calculatedHeight")||m.height||0
}c*=i;q*=i;if(!b&&(c===this._scroll_contentWidth)&&(q===this._scroll_contentHeight)){return
}this._scroll_contentWidth=c;this._scroll_contentHeight=q;k=this.getPath("containerView.frame");
j=k.width;n=k.height;if(this.get("hasHorizontalScroller")&&(o=this.get("horizontalScrollerView"))){if(this.get("autohidesHorizontalScroller")){this.set("isHorizontalScrollerVisible",c>j)
...
if(e){e._viewFrameDidChange();if(SC.platform.touch){this._applyCSSTransforms(e.get("layer"))
...
this.notifyPropertyChange("displayItems")},displayProperties:["displayItems","isEnabled","layoutDirection"],renderDelegateName:"radioGroupRenderDelegate",displayItems:function(){var j=this.get("items"),o=this.get("value"),g=SC.isArray(o),f=this.get("localize"),c=this.get("itemTitleKey"),e=this.get("itemValueKey"),n=this.get("itemWidthKey"),b=this.get("layoutDirection")===SC.LAYOUT_HORIZONTAL,i=this.get("itemIsEnabledKey"),v=this.get("itemIconKey"),u=this._displayItems||[],p=(j)?j.get("length"):0,s,w,k,l,h,t,q,m,a;
for(h=0;h<p;h++){s=j.objectAt(h);if(SC.typeOf(s)===SC.T_ARRAY){w=s[0];l=s[1]}else{if(s){if(c){w=s.get?s.get(c):s[c]
}else{w=(s.toString)?s.toString():null}if(n&&b){k=s.get?s.get(n):s[n]}if(e){l=s.get?s.get(e):s[e]
}else{l=s}if(i){t=s.get?s.get(i):s[i]}else{t=YES}if(v){q=s.get?s.get(v):s[v]}else{q=null
}}else{w=l=q=null;t=NO}}if(s){m=(g)?(o.indexOf(l)>=0):(o===l)}else{m=NO}if(f){w=w.loc()
}u.push(SC.Object.create({title:w,icon:q,width:k,value:l,isEnabled:t,isSelected:(g&&o.indexOf(l)>=0&&o.length===1)||(o===l),isMixed:(g&&o.indexOf(l)>=0),isActive:this._activeRadioButton===h,theme:this.get("theme"),renderState:{}}))
}return u}.property("value","items","itemTitleKey","itemWidthKey","itemValueKey","itemIsEnabledKey","localize","itemIconKey").cacheable(),mouseDown:function(a){if(!this.get("isEnabled")){return YES
}var e=this.get("renderDelegate"),c=this.get("renderDelegateProxy");var b=e.indexForEvent(c,this.$(),a);
this._activeRadioButton=b;if(b!==undefined){this.get("displayItems")[b].set("isActive",YES);
e.updateRadioAtIndex(c,this.$(),b)}a.allowDefault();return YES},mouseUp:function(a){if(!this.get("isEnabled")){return YES
}var e=this.get("renderDelegate"),c=this.get("renderDelegateProxy"),f=this.get("displayItems");
var b=e.indexForEvent(c,this.$(),a);if(this._activeRadioButton!==undefined&&b!==this._activeRadioButton){f[this._activeRadioButton].set("isActive",NO);
e.updateRadioAtIndex(c,this.$(),this._activeRadioButton)}this._activeRadioButton=undefined;
if(b!==undefined){f[b].set("isActive",NO);e.updateRadioAtIndex(c,this.$(),b);this.set("value",f[b].value)
...
}.observes("width"),updateItem:function(e,c){var h=e.get("itemKeys"),g,a=e.get("viewKeys"),f,b;
for(b=h.get("length")-1;b>=0;b--){g=e.get(h.objectAt(b));f=a.objectAt(b);if(!SC.none(c.get(g))){this.set(f,c.get(g))
...
this.itemsDidChange()},itemsDidChange:function(){var k=this.get("items")||[],p,c,m=this.get("childViews"),h,n=this.get("value"),b,o=this.get("itemKeys"),a,l=this.get("viewKeys"),f,g,e;
if(m.get("length")>k.get("length")){for(g=m.get("length")-1;g>=k.get("length");g--){h=m.objectAt(g);
if(SC.isArray(n)){n.removeObject(h.get("value"))}else{if(n===h.get("value")){n=null
}}this.removeChild(h)}this.set("value",n)}else{if(m.get("length")<k.get("length")){for(g=m.get("length");
g<k.get("length");g++){h=SC.SegmentView.create({controlSize:this.get("controlSize"),localize:this.get("localize")});
this.appendChild(h)}}}m=this.get("childViews");for(g=0;g<k.get("length");g++){c=k.objectAt(g);
...
h.set("isLastSegment",g===k.get("length")-1);h.updateItem(this,c)}}.observes("*items.[]"),itemContentDidChange:function(f,e,b,c){var a=this.get("items"),g=this.get("childViews"),h;
h=g.objectAt(c);if(h){h.updateItem(this,f)}else{SC.Logger.warn("Item content change was observed on item without matching segment child view.")
...
if(b){b.becomeFirstResponder()}else{e.allowDefault()}return YES}if(!this.get("allowsMultipleSelection")&&!this.get("allowsEmptySelection")){f=this.get("displayItems").slice(0);
a=f.get("length");j=this.get("value");c=SC.isArray(j);if(e.which===39||e.which===40){for(g=0;
g<a-1;g++){h=f.objectAt(g);if(c?(j.indexOf(h.get("value"))>=0):(h.get("value")===j)){this.triggerItemAtIndex(g+1)
}}return YES}else{if(e.which===37||e.which===38){for(g=1;g<a;g++){h=f.objectAt(g);
if(c?(j.indexOf(h.get("value"))>=0):(h.get("value")===j)){this.triggerItemAtIndex(g-1)
}}return YES}}}return YES},mouseDown:function(a){var c=this.get("childViews"),e,b;
if(!this.get("isEnabled")){return YES}b=this.displayItemIndexForEvent(a);if(b>=0){e=c[b];
e.set("isActive",YES);this.activeChildView=e;this._isMouseDown=YES}return YES},mouseUp:function(a){var c,b;
...
}return YES},mouseMoved:function(a){var e=this.get("childViews"),c,f,b;if(this._isMouseDown){b=this.displayItemIndexForEvent(a);
c=this.activeChildView;f=e[b];if(f&&f!==c){if(c){c.set("isActive",NO)}f.set("isActive",YES);
this.activeChildView=f}}return YES},mouseEntered:function(a){var c=this.get("childViews"),e,b;
if(this._isMouseDown){b=this.displayItemIndexForEvent(a);if(b>=0){e=c[b];e.set("isActive",YES);
this.activeChildView=e}}return YES},mouseExited:function(a){var b;if(this._isMouseDown){b=this.activeChildView;
if(b){b.set("isActive",NO)}this.activeChildView=null}return YES},touchStart:function(e){var b=this.get("childViews"),c,a;
if(!this.get("isEnabled")){return YES}a=this.displayItemIndexForEvent(e);if(a>=0){c=b[a];
...
return YES},touchesDragged:function(a,f){var h=this.touchIsInBoundary(a),e=this.get("childViews"),c,g,b;
if(h){if(!this._isTouching){this._touchDidEnter(a)}b=this.displayItemIndexForEvent(a);
c=this.activeChildView;g=e[b];if(g&&g!==c){if(c){c.set("isActive",NO)}g.set("isActive",YES);
this.activeChildView=g}}else{if(this._isTouching){this._touchDidExit(a)}}this._isTouching=h;
return YES},_touchDidExit:function(a){var b;b=this.activeChildView;b.set("isActive",NO);
this.activeChildView=null;return YES},_touchDidEnter:function(a){var c=this.get("childViews"),e,b;
b=this.displayItemIndexForEvent(a);if(b>=0){e=c[b];e.set("isActive",YES);this.activeChildView=e
}return YES},triggerItemAtIndex:function(j){var l=this.get("childViews"),h,b,m,c,i,g;
h=l[j];if(!h.get("isEnabled")){return this}i=this.get("allowsEmptySelection");g=this.get("allowsMultipleSelection");
b=h.get("value");m=c=this.get("value");if(SC.empty(m)){m=[]}else{if(!SC.isArray(m)){m=[m]
}}if(!g){if(i&&(m.get("length")===1)&&(m.objectAt(0)===b)){m=[]}else{m=[b]}}else{if(m.indexOf(b)>=0){if(m.get("length")>1||(m.objectAt(0)!==b)||i){m=m.without(b)
}}else{m=m.concat([b])}}switch(m.get("length")){case 0:m=null;break;case 1:m=m.objectAt(0);
break;default:break}var o=this.get("itemActionKey"),a=this.get("itemTargetKey"),f,k=null,e=this.getPath("pane.rootResponder"),n;
if(o&&(n=this.get("items").objectAt(n.index))){f=n.get?n.get(o):n[o];if(a){k=n.get?n.get(a):n[a]
}if(e){e.sendAction(f,k,this,this.get("pane"))}}if(!f&&c!==undefined){this.set("value",m)
}f=this.get("action");if(f&&e){e.sendAction(f,this.get("target"),this,this.get("pane"))
}},valueDidChange:function(){var b=this.get("value"),c=this.get("childViews"),e;for(var a=c.get("length")-1;
a>=0;a--){e=c.objectAt(a);if(SC.isArray(b)?b.indexOf(e.get("value"))>=0:b===e.get("value")){e.set("isSelected",YES)
}else{e.set("isSelected",NO)}}}.observes("value"),acceptsFirstResponder:function(){if(!SC.SAFARI_FOCUS_BEHAVIOR){return this.get("isEnabled")
}else{return NO}}.property("isEnabled"),willBecomeKeyResponderFrom:function(a){if(!this._isFocused){this._isFocused=YES;
...
g.push(a);this.set("childViews",g);return this},containerView:SC.ContainerView.extend({theme:"well"}),segmentedView:SC.SegmentedView});
...
}}},normalize:function(f){var l=this.primaryKey,c=this.get("id"),m=this.get("store"),o=this.get("storeKey"),n,i,e,s,h,q,b,a,k,p,j;
var g=m.readEditableDataHash(o)||{};g[l]=c;s=m.readDataHash(o);for(n in this){i=this[n];
if(i){e=i.typeClass;if(e){p=i.get("key")||n;b=SC.typeOf(e.call(i))===SC.T_CLASS;a=i.isChildRecordTransform;
if(!b&&!a){h=this.get(n);if(h!==undefined||(h===null&&f)){j=this[n];if(SC.instanceOf(j,SC.RecordAttribute)){h=j.fromType(this,n,h)
}g[p]=h}}else{if(a){h=this.get(n);if(h&&h.normalize){h.normalize()}}else{if(b){h=s[p];
if(h!==undefined){g[p]=h}else{k=i.get("defaultValue");if(SC.typeOf(k)===SC.T_FUNCTION){g[p]=k(this,n,k)
}else{g[p]=k}}}}}}}}return this},unknownProperty:function(b,e){if(e!==undefined){var c=this.get("storeKey"),f=SC.Store.recordTypeFor(c);
...
}else{a=SC.T_FUNCTION}}return b}.property("typeClass").cacheable(),toType:function(f,k,j){var c=this.get("transform"),h=this.get("typeClass"),b;
if(c&&c.to){j=c.to(j,this,h,f,k);if(!SC.none(j)&&(b=c.observesChildren)){var e,g=b.length,a={record:f,key:k};
for(e=0;e<g;e++){j.addObserver(b[e],this,this._SCRA_childObserver,a)}}}return j},_SCRA_childObserver:function(f,e,b,c,a){this.call(c.record,c.key,f);
c.record.notifyPropertyChange(c.key)},fromType:function(a,c,f){var b=this.get("transform"),e=this.get("typeClass");
...
}SC.RecordAttribute.registerTransform(SC.Set,{to:function(f,a,e,b,c){return SC.Set.create(f)
},from:function(f,a,e,b,c){return f.toArray()},observesChildren:["[]"]});sc_require("models/record");
sc_require("models/record_attribute");SC.ChildAttribute=SC.RecordAttribute.extend({isChildRecordTransform:YES,toType:function(e,c,f){var b=null,g=SC.keyFor("__kid__",SC.guidFor(this)),h=this.get("typeClass");
...
}}}if(j&&(!g||this.get("isMaster"))){j.recordDidChange(f)}this.enumerableContentDidChange(o,e,l-e);
return this},removeInverseRecord:function(c){if(!c){return this}var f=c.get("id"),e=this.get("editableStoreIds"),a=(e&&f)?e.indexOf(f):-1,b;
if(a>=0){e.removeAt(a);if(this.get("isMaster")&&(b=this.get("record"))){b.recordDidChange(this.get("propertyName"))
...
}this._insideFlush=YES;var i=this.get("storeKeys"),g=this._scq_changedStoreKeys,h=NO,l=SC.Record,q=[],b=new Date(),e,f,c,s,p,j;
var m=i;if(i&&!a){if(g){g.forEach(function(t){if(q.length>0||new Date()-b>SC.RecordArray.QUERY_MATCHING_THRESHOLD){q.push(t);
return}f=n.peekStatus(t);if(!(f&l.EMPTY)&&!((f&l.DESTROYED)||(f===l.BUSY_DESTROYING))){e=n.materializeRecord(t);
j=!!(e&&k.contains(e))}else{j=NO}if(j){if(i.indexOf(t)<0){if(!h){i=i.copy()}i.pushObject(t)
}}else{if(i.indexOf(t)>=0){if(!h){i=i.copy()}i.removeObject(t)}}},this);h=YES}}else{if(p=k.get("scope")){s=p.flush().get("storeKeys")
}else{if(c=k.get("expandedRecordTypes")){s=SC.IndexSet.create();c.forEach(function(t){s.addEach(n.storeKeysFor(c))
})}}i=[];s.forEach(function(t){if(q.length>0||new Date()-b>SC.RecordArray.QUERY_MATCHING_THRESHOLD){q.push(t);
return}f=n.peekStatus(t);if(!(f&l.EMPTY)&&!((f&l.DESTROYED)||(f===l.BUSY_DESTROYING))){e=n.materializeRecord(t);
if(e&&k.contains(e)){i.push(t)}}});h=YES}if(q.length>0){var o=this;window.setTimeout(function(){SC.run(function(){if(!o||o.get("isDestroyed")){return
}o.set("needsFlush",YES);o._scq_changedStoreKeys=SC.IndexSet.create().addEach(q);
o.flush()})},1)}if(g){g.clear()}if(h){if(i&&(i===m)){i=i.copy()}i=SC.Query.orderStoreKeys(i,k,n);
if(SC.compare(m,i)!==0){this.set("storeKeys",SC.clone(i))}}this._insideFlush=NO;return this
...
if(SC.none(n)||n===""||SC.none(j)){this.set("searchResults",j)}else{n=this._sanitizeSearchString(n).toLowerCase();
...
},touchExited:function(a){return this.mouseExited(a)},renderMixin:function(c,g){if(this.get("hasHover")){var e=this.get("hoverClass");
...
var e=this.get("isImage"),a;if(this.get("alwaysEnableToolTip")&&!b){b=this.get("title")
...
}.observes("isBusy"),_selectedObjectDidChange:function(){var e=this.get("selectedObject");
var a=this.get("textFieldView");var b,c;this.setIfChanged("value",this._getObjectValue(e,this.get("valueKey")));
if(a){a.setIfChanged("value",this._getObjectName(e,this.get("nameKey"),this.get("localize")))
}if(this._listView.getPath("selection.firstObject")!==e){c=this._listView.get("content")||[];
b=c.indexOf(e);if(b>=0){this._listView.select(b)}}this.set("filter",null)}.observes("selectedObject"),_valueDidChange:function(){var e=this.get("value");
var a=this.get("selectedObject");var b=this.get("valueKey");var c;if(e){if(b){if(e!==this._getObjectValue(a,b)){c=this.get("objects");
a=(c&&c.isEnumerable)?c.findProperty(b,e):null;this.setIfChanged("selectedObject",a)
}}else{this.setIfChanged("selectedObject",e)}}else{this.setIfChanged("selectedObject",null)
...
this._listPane=SC.PickerPane.create({classNames:["scui-combobox-list-pane","sc-menu"],acceptsKeyPane:NO,acceptsFirstResponder:NO,contentView:SC.View.extend({layout:{left:0,right:0,top:0,bottom:0},childViews:"listView spinnerView".w(),listView:b.extend({classNames:"scui-combobox-list-scroll-view",layout:{left:0,right:0,top:0,bottom:c?a:0},hasHorizontalScroller:NO,contentView:SC.ListView.design({classNames:"scui-combobox-list-view",layout:{left:0,right:0,top:0,bottom:0},allowsMultipleSelection:NO,target:this,action:"_selectListItem",contentBinding:SC.Binding.from("filteredObjects",this).oneWay(),contentValueKey:this.get("nameKey"),hasContentIcon:this.get("iconKey")?YES:NO,contentIconKey:this.get("iconKey"),selectionBinding:SC.Binding.from("_listSelection",this),localizeBinding:SC.Binding.from("localize",this).oneWay(),exampleView:SC.ListItemView.extend({maxNameLength:this.get("maxNameLength"),localize:this.get("localize"),renderLabel:function(g,f){var e=this.get("maxNameLength");
if(!SC.none(e)){f=this.truncateMaxLength(f,e);g.push("<label>",f||"","</label>")}else{return arguments.callee.base.apply(this,arguments)
}},truncateMaxLength:function(j,f){var h,k,e,g=j;if((SC.typeOf(j)===SC.T_STRING)&&(j.length>f)){k=Math.max(Math.ceil((f-3)/2),0);
e=Math.max(f-3-k,0);g=j.substring(0,k);for(h=0;(h<3)&&((h+k)<f);h++){g=g+"."}g=g+j.substring(j.length-e)
}return g}}),mouseUp:function(){var e=arguments.callee.base.apply(this,arguments);
...
}return b.queryCommandState("justifyfull")}.property("selection").cacheable(),_alignContentForIE:function(g){var e=this._document;
var c=this._getSelectedElement();var a=e.selection.createRange();var b,f;if(c.nodeName==="IMG"){if(g!=="justify"){c.style.textAlign=g;
c.align=g}}else{if(c.nodeName!=="DIV"){b=a.htmlText;f='<div align="%@" style="text-align: %@">%@</div>'.fmt(g,g,b);
a.pasteHTML(f)}else{if(c.innerText!==a.text){b=a.htmlText;f='<div align="%@" style="text-align: %@">%@</div>'.fmt(g,g,b);
a.pasteHTML(f)}else{c.style.textAlign=g;c.align=g}}}},selectionIsOrderedList:function(a,c){var b=this._document;
...
e.push(b);this.set("childViews",e);return this},containerView:SC.ContainerView,selectFieldView:SC.SelectButtonView.extend({layout:{left:4,right:0,height:24},items:function(a,b){if(b===undefined){return this.get("objects")
...
f.push(b);this.set("childViews",f)}});SCUI.TimeSelectorFieldView=SC.View.extend({classNames:["scui-timeselector"],value:null,layout:{minHeight:24,minWidth:100},_hour:null,_minute:null,_meridian:null,_getCurrentTime:function(){var a=new Date();
...
},_setTime:function(){var a=this.get("_hour"),e=this.get("_minute"),b=this.get("_meridian"),c=new Date();
e=this._validNumber(e);c=SC.DateTime.create(c);if(b==="PM"){a=a+12}this.set("value",c.adjust({hour:a,minute:e}))
},getHour:function(c,b){var a,e=this.get("value");if(!e){e=this._getCurrentTime()
}if(b!==undefined){a=this._validNumber(b);if(a>12&&a<24){a=a-12}this.set("_hour",a);
this._setTime()}else{if(e){a=e.toFormattedString("%i")}else{a=this.get("_hour")}}return a
}.property("value").cacheable(),getMinute:function(b,a){var e,c=this.get("value");
if(!c){c=this._getCurrentTime()}if(a!==undefined){e=this._validNumber(a);this.set("_minute",e);
this._setTime()}else{if(c){e=c.toFormattedString("%M")}else{e=this.get("_minute")
}}return e}.property("value").cacheable(),getMeridian:function(b,a){var c,e=this.get("value");
if(a!==undefined){c=a;this.set("_meridian",c);this._setTime()}else{if(e){c=e.toFormattedString("%p")
...
SCUI.UploadView=SC.View.extend({value:null,uploadTarget:null,status:"",inputName:"Filedata",displayProperties:"uploadTarget".w(),render:function(c,i){var e=this.get("layerId")+"Frame";
