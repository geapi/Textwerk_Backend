...
SCUI.CalendarView=SC.View.extend({weekdayStrings:["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],monthStartOn:SC.DateTime.create({day:1}),selectedDate:null,displayProperties:["monthStartOn"],resetToSelectedDate:function(){var a=this.get("selectedDate");
